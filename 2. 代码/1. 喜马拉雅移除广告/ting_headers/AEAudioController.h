...
@class ABAudioFilterPort, ABAudioReceiverPort, ABAudioSenderPort, AEBlockChannel, AEFloatConverter, AEMessageQueue, NSArray, NSError, NSString, NSTimer;
...
@interface AEAudioController : NSObject
{
    ...
    ABAudioFilterPort *_audiobusFilterPort;
...
@property(retain, nonatomic) ABAudioFilterPort *audiobusFilterPort; // @synthesize audiobusFilterPort=_audiobusFilterPort;
...
@property(readonly, nonatomic) AEMessageQueue *messageQueue; // @synthesize messageQueue=_messageQueue;
...
@property(retain, nonatomic) ABAudioSenderPort *audiobusSenderPort; // @dynamic audiobusSenderPort;
...
- (void)averageWavPowerLevel:(float *)arg1 peakHoldLevel:(float *)arg2 forGroup:(struct _channel_group_t *)arg3;
...
- (struct _channel_group_t *)createNoMixerGroup;
- (struct _channel_group_t *)createChannelGroup;
- (struct _channel_group_t *)getTopChannelGroup;
