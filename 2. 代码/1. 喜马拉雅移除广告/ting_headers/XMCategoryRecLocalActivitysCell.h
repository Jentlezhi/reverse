...
@protocol XMCategoryRecLocalActivitysDelegate;

@interface XMCategoryRecLocalActivitysCell : XMFindFlowWhiteBackTableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
    struct CGSize _itemSize;
    XMCategoryRecModel *_model;
    id <XMCategoryRecLocalActivitysDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <XMCategoryRecLocalActivitysDelegate> delegate; // @synthesize delegate=_delegate;
