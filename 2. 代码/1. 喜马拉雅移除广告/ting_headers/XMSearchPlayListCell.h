...
@class UILabel, XMSearchPlayListModel, XMWebImageView, YYLabel;

@interface XMSearchPlayListCell : UITableViewCell
{
    XMSearchPlayListModel *_model;
...
@property(retain, nonatomic) XMSearchPlayListModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
