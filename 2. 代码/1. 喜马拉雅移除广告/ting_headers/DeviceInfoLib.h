...
@interface DeviceInfoLib : NSObject
{
    ...
    NSString *_faceSdkName;
    NSString *_faceSdkVersion;
}

+ (id)shareDevice;
@property(copy, nonatomic) NSString *faceSdkVersion; // @synthesize faceSdkVersion=_faceSdkVersion;
@property(copy, nonatomic) NSString *faceSdkName; // @synthesize faceSdkName=_faceSdkName;
