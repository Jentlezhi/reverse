...
@class NSArray, NSMutableDictionary, NSString, XMRankItem, XMRankingTagsView, XMSegmentTabViewController;

@interface XMRankingUserTabViewController : XMSubLevelViewController <XMSegmentTabViewCtrolDelegate, XMRankingTagsViewDelegate>
{
