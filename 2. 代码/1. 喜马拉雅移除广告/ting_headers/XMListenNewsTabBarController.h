...
@class NSMutableArray, NSMutableDictionary, NSString, XMSegmentTabViewController;

@interface XMListenNewsTabBarController : XMSubLevelViewController <XMSegmentTabViewCtrolDelegate>
{
    XMSegmentTabViewController *_tabController;
    NSMutableArray *_tags;
    NSMutableArray *_albumIds;
    NSMutableDictionary *_viewControllers;
}

@property(retain, nonatomic) NSMutableDictionary *viewControllers; // @synthesize viewControllers=_viewControllers;
@property(retain, nonatomic) NSMutableArray *albumIds; // @synthesize albumIds=_albumIds;
