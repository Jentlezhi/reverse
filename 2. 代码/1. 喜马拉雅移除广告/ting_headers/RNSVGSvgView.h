...
@property(retain, nonatomic) NSString *bbHeight; // @synthesize bbHeight=_bbHeight;
@property(retain, nonatomic) NSString *bbWidth; // @synthesize bbWidth=_bbWidth;
- (void).cxx_destruct;
...
- (void)setBBHeight:(id)arg1;
- (void)setBBWidth:(id)arg1;
- (void)invalidate;
