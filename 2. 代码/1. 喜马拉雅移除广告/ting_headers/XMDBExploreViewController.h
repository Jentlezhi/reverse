...
@interface XMDBExploreViewController : XMSubLevelViewController <UITableViewDelegate, UITableViewDataSource>
{
    NSString *_dbPath;
...
+ (void)openDBWithDetals:(id)arg1;
+ (void)openDBWithPath:(id)arg1;
+ (_Bool)isDBWithPath:(id)arg1;
...
- (void).cxx_destruct;
- (id)getDetailInTableWithName:(id)arg1;
