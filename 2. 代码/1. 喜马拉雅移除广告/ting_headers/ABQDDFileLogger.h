...
@class ABQDDLogFileInfo, NSFileHandle, NSObject, NSString;
@protocol ABQDDLogFileManager, OS_dispatch_source;

@interface ABQDDFileLogger : ABQDDAbstractLogger <ABQDDLogger>
{
    id <ABQDDLogFileManager> logFileManager;
    ABQDDLogFileInfo *currentLogFileInfo;
...
@property(readonly, nonatomic) id <ABQDDLogFileManager> logFileManager; // @synthesize logFileManager;
- (void).cxx_destruct;
- (id)loggerName;
