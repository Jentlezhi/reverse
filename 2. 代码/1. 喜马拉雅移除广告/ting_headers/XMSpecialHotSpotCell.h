...
@interface XMSpecialHotSpotCell : UITableViewCell
{
    UILabel *_positionLabel;
    UILabel *_keywordLabel;
    UIView *_bgView;
    UIImageView *_positionDecorate;
}

+ (double)tableView:(id)arg1 heightForCellObject:(id)arg2;
@property(retain, nonatomic) UIImageView *positionDecorate; // @synthesize positionDecorate=_positionDecorate;
