...
@class NSArray, NSString, SWUtilityButtonView, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIScrollView, UITableView, UITapGestureRecognizer, UIView;
@protocol SWTableViewCellDelegate;

@interface SWTableViewCell : XMTableViewCell <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
