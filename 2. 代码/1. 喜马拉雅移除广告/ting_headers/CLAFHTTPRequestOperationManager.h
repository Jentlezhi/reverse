...
@class CLAFHTTPRequestSerializer, CLAFHTTPResponseSerializer, CLAFNetworkReachabilityManager, CLAFSecurityPolicy, NSOperationQueue, NSURL, NSURLCredential;
@protocol CLAFURLRequestSerialization, CLAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface CLAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    CLAFHTTPRequestSerializer<CLAFURLRequestSerialization> *_requestSerializer;
    CLAFHTTPResponseSerializer<CLAFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    CLAFSecurityPolicy *_securityPolicy;
    CLAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) CLAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) CLAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) CLAFHTTPResponseSerializer<CLAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) CLAFHTTPRequestSerializer<CLAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
