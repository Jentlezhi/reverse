...
@interface XMUBTSwizzledObject : NSObject
{
...
- (void).cxx_destruct;
- (id)initWithBoolBlock:(CDUnknownBlockType)arg1 named:(id)arg2 forClass:(Class)arg3 selector:(SEL)arg4 originalMethod:(CDUnknownFunctionPointerType)arg5 withNumArgs:(unsigned int)arg6;
