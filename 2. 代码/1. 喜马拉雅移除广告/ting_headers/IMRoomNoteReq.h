...
@interface IMRoomNoteReq : GPBMessage
{
}
...
@property(nonatomic) _Bool hasMaxNoteId; // @dynamic hasMaxNoteId;
...
@property(nonatomic) unsigned long long maxNoteId; // @dynamic maxNoteId;
