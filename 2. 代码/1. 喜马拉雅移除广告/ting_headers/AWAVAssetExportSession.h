...
@protocol AWAVAssetExportSessionDelegate, OS_dispatch_queue;

@interface AWAVAssetExportSession : NSObject
{
    NSError *_error;
    double duration;
    ...
    float _progress;
    id <AWAVAssetExportSessionDelegate> _delegate;
    AVAsset *_asset;
...
@property(nonatomic) __weak id <AWAVAssetExportSessionDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)reset;
- (void)cancelExport;
