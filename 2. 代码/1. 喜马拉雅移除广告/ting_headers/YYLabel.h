...
- (void)handleMenuEvent4:(id)arg1;
- (void)handleMenuEvent3:(id)arg1;
- (void)handleMenuEvent2:(id)arg1;
- (void)handleMenuEvent1:(id)arg1;
- (void)resetAllMenuItems;
- (void)addMenuItemTitle:(id)arg1 eventHandler:(CDUnknownBlockType)arg2;
- (_Bool)canBecomeFirstResponder;
- (void)copyText:(id)arg1;
- (void)handleMenuEvent:(id)arg1;
