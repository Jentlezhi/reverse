...
@class XMSoundComment;

@interface XMAutoCycleCommonCellLayout : XMCommentCommonCellLayout
{
    struct CGRect _containerViewFrame;
}

+ (id)newLayout:(id)arg1;
@property(readonly, nonatomic) struct CGRect containerViewFrame; // @synthesize containerViewFrame=_containerViewFrame;
