...
#import "Controller/CityListViewController.h"
...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2{
   ...
   if ([arg2 section] != [self numberOfSectionsInTableView:arg1] - 1)
    ...
    cell.textLabel.text = [arg2 row] == 0 ? @"城市列表" : @"退出微信";
...
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2 {
	...
	if ([arg2 row] == 0)
	{
		CityListViewController *list = [[CityListViewController alloc] init];
		[self.navigationController pushViewController:list animated:YES];

	}else if([arg2 row] == 1){
    
    NSData *data = [[NSData alloc] initWithContentsOfFile:ZJFile(data.json)];
	NSString *dataStr = data == nil ? @"空":@"非空";
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"提示" message:dataStr preferredStyle:UIAlertControllerStyleActionSheet];
