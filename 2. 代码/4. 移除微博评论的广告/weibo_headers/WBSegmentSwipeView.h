...
#import "WBArticleSwipeGuideView-Protocol.h"

@class NSArray, NSMutableDictionary, NSMutableIndexSet, NSMutableSet, NSString, NSTimer, UIScrollView;
@protocol SwipeViewDataSource, SwipeViewDelegate;

@interface WBSegmentSwipeView : UIView <WBArticleSwipeGuideView, UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    _Bool _enableViewResponderVCLifeCycleMangling;
    _Bool _firstSetIndex;
    ...
    double _autoscroll;
    NSArray *_changeProgressCheckPoints;
    ...
    NSTimer *_timer;
    NSArray *_moveGroups;
    NSArray *_durationGroups;
    long long _currentMove;
    long long _lastItemIndex;
    long long _beginDraggingItemIndex;
    NSMutableDictionary *_changeProgressCheckPointsDic;
    NSMutableIndexSet *_dismissingViewIndexes;
    NSMutableIndexSet *_appearingViewIndexes;
    struct CGSize _itemSize;
    struct CGPoint _previousContentOffset;
}

@property(retain, nonatomic) NSMutableIndexSet *appearingViewIndexes; // @synthesize appearingViewIndexes=_appearingViewIndexes;
@property(retain, nonatomic) NSMutableIndexSet *dismissingViewIndexes; // @synthesize dismissingViewIndexes=_dismissingViewIndexes;
@property(nonatomic) _Bool firstSetIndex; // @synthesize firstSetIndex=_firstSetIndex;
@property(retain, nonatomic) NSMutableDictionary *changeProgressCheckPointsDic; // @synthesize changeProgressCheckPointsDic=_changeProgressCheckPointsDic;
@property(nonatomic) long long beginDraggingItemIndex; // @synthesize beginDraggingItemIndex=_beginDraggingItemIndex;
@property(nonatomic) long long lastItemIndex; // @synthesize lastItemIndex=_lastItemIndex;
@property(nonatomic) long long currentMove; // @synthesize currentMove=_currentMove;
@property(copy, nonatomic) NSArray *durationGroups; // @synthesize durationGroups=_durationGroups;
@property(copy, nonatomic) NSArray *moveGroups; // @synthesize moveGroups=_moveGroups;
...
@property(nonatomic) _Bool enableViewResponderVCLifeCycleMangling; // @synthesize enableViewResponderVCLifeCycleMangling=_enableViewResponderVCLifeCycleMangling;
@property(retain, nonatomic) NSArray *changeProgressCheckPoints; // @synthesize changeProgressCheckPoints=_changeProgressCheckPoints;
...
- (void)_viewEndDisAppear:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)_viewWillBeginDisAppear:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)_viewEndAppear:(id)arg1 atIndex:(unsigned long long)arg2;
- (void)_viewWillBeginAppear:(id)arg1 atIndex:(unsigned long long)arg2;
...
- (void)scrollToItemAtIndex:(long long)arg1 duration:(double)arg2 isClickScroll:(_Bool)arg3;
...
- (void)scrollByMoveGroups:(id)arg1 duration:(id)arg2;
...
- (void)_setupCheckPointsWithIndex:(long long)arg1;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1;
- (id)initWithCoder:(id)arg1;
- (void)setUp;
- (Class)scrollViewClass;
- (void)swipToRate:(double)arg1 duration:(double)arg2 backDuration:(double)arg3 completion:(CDUnknownBlockType)arg4;
