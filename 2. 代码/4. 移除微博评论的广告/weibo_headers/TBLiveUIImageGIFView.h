...
@class CADisplayLink, TBLiveAnimatedImage, UIImage;

@interface TBLiveUIImageGIFView : UIImageView
{
    _Bool _notifyPlayLoopWhenIndefinitelyRepeating;
    _Bool _shouldAnimate;
    _Bool _needsDisplayWhenImageBecomesAvailable;
    TBLiveAnimatedImage *_animatedImage;
...
@property(nonatomic) _Bool notifyPlayLoopWhenIndefinitelyRepeating; // @synthesize notifyPlayLoopWhenIndefinitelyRepeating=_notifyPlayLoopWhenIndefinitelyRepeating;
...
@property(retain, nonatomic) TBLiveAnimatedImage *animatedImage; // @synthesize animatedImage=_animatedImage;
- (void).cxx_destruct;
