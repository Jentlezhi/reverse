...
@class NSMutableArray, NSMutableIndexSet, NSString, UIView, WBVideoInstreamAdImagePlayController, WBVideoInstreamAdItem, WBVideoInstreamAdPlaybackController, WBVideoItem, WBVideoPlayerController;
@protocol WBVideoInstreamAdControllerDelegate, WBVideoPlayerSourceView;

@interface WBVideoInstreamAdController : NSObject <WBVideoPlayerControllerDelegate, WBVideoAdImageControllerDelegate>
{
    ...
    WBVideoInstreamAdImagePlayController *_imagePlaybackController;
...
@property(retain, nonatomic) WBVideoInstreamAdImagePlayController *imagePlaybackController; // @synthesize imagePlaybackController=_imagePlaybackController;
...
- (void).cxx_destruct;
- (void)postPlaybackDidEndNotification:(id)arg1;
- (void)postPlaybackDidStartNotification:(id)arg1;
- (_Bool)isInstreamAdVideoPlaying;
- (void)videoAdImageControllerDidPlayToEnd:(id)arg1;
- (void)videoAdImageController:(id)arg1 didFailWithError:(id)arg2;
- (void)videoAdImageControllerPressed:(id)arg1;
- (void)videoAdImageControllerIsReady:(id)arg1;
...
- (void)logInstreamAdPluginPressedWithVideoItem:(id)arg1;
...
- (long long)startImagePlaybackWithAdItem:(id)arg1 isMidRoll:(_Bool)arg2 group:(id)arg3;
- (long long)startVideoPlaybackWithAdItem:(id)arg1 isMidRoll:(_Bool)arg2 group:(id)arg3;
