...
@interface WBOpenUrlSearchContext : WBOpenUrlContextBase <UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning>
{
...
- (void)customDismiss:(id)arg1;
- (void)customPresent:(id)arg1;
