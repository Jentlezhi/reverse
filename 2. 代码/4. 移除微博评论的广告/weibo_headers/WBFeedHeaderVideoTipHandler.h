...
@class HomeViewHeaderManager, NSString, WBVideoMainGroupBannerController;

@interface WBFeedHeaderVideoTipHandler : NSObject <HeaderHandleProtocol>
{
    HomeViewHeaderManager *_headerManager;
    WBVideoMainGroupBannerController *_videoBannerController;
}

@property(nonatomic) __weak WBVideoMainGroupBannerController *videoBannerController; // @synthesize videoBannerController=_videoBannerController;
