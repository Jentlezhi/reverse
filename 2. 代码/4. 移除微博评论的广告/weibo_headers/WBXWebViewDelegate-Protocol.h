...
@class WBXWebView, WKNavigation, WKScriptMessage, WKUserContentController, WKWebView;

@protocol WBXWebViewDelegate <NSObject>
- (void)webView:(WKWebView *)arg1 didFinishNavigation:(WKNavigation *)arg2;
- (void)wbxwebviewTerminaled:(WBXWebView *)arg1;
