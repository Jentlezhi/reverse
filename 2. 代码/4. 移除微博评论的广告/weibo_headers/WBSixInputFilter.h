...
@property(nonatomic) int filterInputTextureUniform6; // @synthesize filterInputTextureUniform6;
@property(nonatomic) int filterTextureCoordinateAttribute6; // @synthesize filterTextureCoordinateAttribute6;
- (void).cxx_destruct;
