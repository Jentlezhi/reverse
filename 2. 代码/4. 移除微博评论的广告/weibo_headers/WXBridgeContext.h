...
@class NSMutableArray, NSMutableDictionary, WXSDKInstance;
@protocol WXBridgeProtocol, WXDataRenderHandler;

@interface WXBridgeContext : NSObject
{
    _Bool _debugJS;
    _Bool _frameworkLoadFinished;
    id <WXDataRenderHandler> _dataRenderHandler;
...
@property(readonly, nonatomic) id <WXDataRenderHandler> dataRenderHandler; // @synthesize dataRenderHandler=_dataRenderHandler;
- (void).cxx_destruct;
- (void)_sendQueueLoop;
...
- (_Bool)_shouldMountExtInfoToInstanceContxt;
