...
@class NSString, SNHTTPRequestOperationWrapper, UIButton, UIImageView, UILabel, UIPanGestureRecognizer, UIScrollView, UIView, WBDatePickerView, WBProfileTextField, WBProgressHUD, WBStyleButton;
...
- (void)updateUsersAfterCompletionEvent;
