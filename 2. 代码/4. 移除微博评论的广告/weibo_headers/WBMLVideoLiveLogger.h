...
@interface WBMLVideoLiveLogger : NSObject
{
    ...
    NSString *_mediaid;
    NSString *_videoUicode;
    NSString *_errorCode;
    NSString *_errorMsg;
    NSString *_errorDomain;
    NSString *_dnsip;
    NSString *_traceinfo;
    double _roomStartime;
    double _playerStartTime;
    double _playerStopTime;
    double _roomPrepareStopTime;
    double _roomDestoryTime;
    double _roomInitTime;
    double _renderStartTime;
    double _roomPrepareTime;
    double _prepareStartTime;
    double _liveInfoStartTime;
    double _userInfoStartTime;
    double _userInfoTime;
    double _liveInfoTime;
    double _renderTime;
...
@property(nonatomic) double liveInfoTime; // @synthesize liveInfoTime=_liveInfoTime;
@property(nonatomic) double userInfoTime; // @synthesize userInfoTime=_userInfoTime;
@property(nonatomic) double userInfoStartTime; // @synthesize userInfoStartTime=_userInfoStartTime;
@property(nonatomic) double liveInfoStartTime; // @synthesize liveInfoStartTime=_liveInfoStartTime;
@property(nonatomic) double prepareStartTime; // @synthesize prepareStartTime=_prepareStartTime;
@property(nonatomic) double roomPrepareTime; // @synthesize roomPrepareTime=_roomPrepareTime;
@property(nonatomic) double renderStartTime; // @synthesize renderStartTime=_renderStartTime;
@property(nonatomic) double roomInitTime; // @synthesize roomInitTime=_roomInitTime;
@property(nonatomic) double roomDestoryTime; // @synthesize roomDestoryTime=_roomDestoryTime;
@property(nonatomic) double roomPrepareStopTime; // @synthesize roomPrepareStopTime=_roomPrepareStopTime;
@property(nonatomic) double playerStopTime; // @synthesize playerStopTime=_playerStopTime;
@property(nonatomic) double playerStartTime; // @synthesize playerStartTime=_playerStartTime;
@property(nonatomic) double roomStartime; // @synthesize roomStartime=_roomStartime;
@property(nonatomic) _Bool isEndInError; // @synthesize isEndInError=_isEndInError;
...
@property(copy, nonatomic) NSString *videoUicode; // @synthesize videoUicode=_videoUicode;
