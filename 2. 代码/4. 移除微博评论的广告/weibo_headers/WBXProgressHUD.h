...
@class NSString, UIButton, UIImage, WBXProgressHUDView;

@interface WBXProgressHUD : UIView
{
...
+ (id)showWarningWithText:(id)arg1 duration:(double)arg2;
