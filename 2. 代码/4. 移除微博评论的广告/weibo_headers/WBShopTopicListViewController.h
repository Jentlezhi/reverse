...
@class NSMutableArray, NSString, SNHTTPRequestOperationWrapper, UIView, WBPRLMTableViewWrapper, WBSearchBar, WBShopShoppingCartView, WBTableView;

@interface WBShopTopicListViewController : WBViewController <UITableViewDelegate, UITableViewDataSource, PRLMTableViewWrapperDelegate, UISearchBarDelegate>
{
    NSString *_topiclisttype;
...
@property(copy, nonatomic) NSString *topiclisttype; // @synthesize topiclisttype=_topiclisttype;
- (void).cxx_destruct;
