...
- (id)_normalizeContentTypeWithJobType:(id)arg1 mediaType:(id)arg2;
- (void)jobSendCancel;
- (void)jobSendFinished;
- (void)jobSendFinished:(_Bool)arg1;
...
- (unsigned long long)uploadBusinessTypeWithMediaCache:(id)arg1;
- (void)addJobStage:(id)arg1;
@property(readonly, nonatomic) NSDictionary *jobCommonLog;
- (void)setJobStage:(id)arg1;
@property(readonly, nonatomic) NSString *jobStage;
@property(retain, nonatomic) NSString *onceJobId;
@property(nonatomic) long long transcodeCount;
