...
@class NSDictionary, NSString, UIPanGestureRecognizer, WBMediaEditorCache, WBStoryCaptureViewController, WBStoryDraftModel, WBStoryNavigationController, WBStoryPublishLogger, WBTopic;
@protocol WBStoryMediaCache;

@interface WBStoryPublishContext : NSObject <UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate, WBStoryCaptureViewControllerDelegate, WBStoryPublishViewControllerDelegate, WBStoryVideoClipViewControllerDelegate>
{
    struct {
        ...
        unsigned int showDraftIntroduce:1;
...
- (void)showDraftIntroduceIfNeeded;
...
- (void)clearCaptureViewController;
- (void)reset;
- (id)init;
- (void)dealloc;
