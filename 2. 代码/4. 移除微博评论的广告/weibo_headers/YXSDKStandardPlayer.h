...
@interface YXSDKStandardPlayer : NSObject
{
    ...
    CDStruct_ad140b50 *_standardPlayer;
...
@property(nonatomic) CDStruct_ad140b50 *standardPlayer; // @synthesize standardPlayer=_standardPlayer;
...
- (void)setTbM3u8PlayOpt:(_Bool)arg1;
...
- (void)setFixSomeMP4NotPlay:(_Bool)arg1;
