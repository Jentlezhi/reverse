...
@interface LiveRoomPowerMsgUtils : NSObject
{
}
...
+ (void)startAccsAfterDefaultBindAppWithAppleToken:(id)arg1 callBack:(CDUnknownBlockType)arg2;
+ (void)startAccsInitByHost:(id)arg1 afterDefaultBindAppWithAppleToken:(id)arg2 callBack:(CDUnknownBlockType)arg3;
