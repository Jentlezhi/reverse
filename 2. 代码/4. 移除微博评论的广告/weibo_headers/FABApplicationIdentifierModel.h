...
@property(readonly, nonatomic) CDStruct_32a7f38a minimumSDK; // @synthesize minimumSDK=_minimumSDK;
@property(readonly, nonatomic) CDStruct_32a7f38a builtSDK; // @synthesize builtSDK=_builtSDK;
