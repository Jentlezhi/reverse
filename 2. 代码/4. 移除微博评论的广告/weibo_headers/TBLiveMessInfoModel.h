...
@class NSArray, NSDictionary, NSString, TBLiveActivityModel, TBLiveAdLayerModel, TBLiveBrandADModel, TBLiveHeadBannerModel, TBLiveItemVideoData, TBLiveTBTVMenuBannerModel;
@protocol TBLiveSwithLiveModel;

@interface TBLiveMessInfoModel : TBLiveJSONModel
{
    ...
    TBLiveHeadBannerModel *_liveHeadBanner;
    NSDictionary *_bizInfo;
    NSDictionary *_visitorIdentity;
}

@property(retain, nonatomic) NSDictionary *visitorIdentity; // @synthesize visitorIdentity=_visitorIdentity;
@property(retain, nonatomic) NSDictionary *bizInfo; // @synthesize bizInfo=_bizInfo;
@property(retain, nonatomic) TBLiveHeadBannerModel *liveHeadBanner; // @synthesize liveHeadBanner=_liveHeadBanner;
