...
@interface WBTDFMDatabase : NSObject
{
    struct sqlite3 *_db;
...
- (void)syncExecuteInOtherQueue:(id)arg1 task:(CDUnknownBlockType)arg2;
...
- (_Bool)existsForQuery:(id)arg1;
- (long long)longLongForQuery:(id)arg1;
- (long long)longLongWithDefault:(long long)arg1 query:(id)arg2;
