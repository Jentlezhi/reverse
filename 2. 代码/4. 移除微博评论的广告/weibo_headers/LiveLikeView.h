...
@class LiveLikeAnimView, NSString, UIButton, UILabel;

@interface LiveLikeView : UIView
{
    ...
    LiveLikeAnimView *_starAnimationView;
}

@property(retain, nonatomic) LiveLikeAnimView *starAnimationView; // @synthesize starAnimationView=_starAnimationView;
