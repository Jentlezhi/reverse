...
@class LOTAnimationView, NSArray, NSString, UIButton, UIImageView, WBContentImageView, WBLittleVideoStoryMusicDiversionControl, WBLittleVideoStoryNewFullScreenOverlayMusicLabel, WBNewStoryWechatControl, WBSTLikeAnimationView, WBStoryFullScreenProgressView, WBStoryNewFullOverlayButton, WBStoryOverlayAvatarView, WBStoryUser, WBStoryUserView;
@protocol WBSTPlayHeaderBaseViewDelegate;

@interface WBNewStorySTPlayVideoVerticalOverlayView : WBSTPlayFooterBaseView <WBSTLikeButtonDelegate, WBStoryFullScreenFooterContainerDelegate>
{
    ...
    WBNewStoryWechatControl *_wechatButton;
...
@property(retain, nonatomic) WBNewStoryWechatControl *wechatButton; // @synthesize wechatButton=_wechatButton;
