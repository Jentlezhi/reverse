...
+ (void)doWithSharedGLContext:(CDUnknownBlockType)arg1;
...
- (void)doWithGLContext:(CDUnknownBlockType)arg1;
- (void)useAsCurrentContext;
- (void)resumeContextQueueIfNeed;
- (void)suspendContextQueueIfNeed;
