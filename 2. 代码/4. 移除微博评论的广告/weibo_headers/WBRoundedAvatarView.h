...
@property(copy, nonatomic) NSString *liveIconUrl; // @synthesize liveIconUrl=_liveIconUrl;
...
@property(retain, nonatomic) WBContentImageView *liveIconView; // @synthesize liveIconView=_liveIconView;
...
- (_Bool)isLiveIconEnable;
- (_Bool)shouldShowLiveIcon;
- (void)updateStoryRingViewWhenLiveStatusChanged;
- (void)updateLiveIconView;
