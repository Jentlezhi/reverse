...
@property(readonly, nonatomic) double contentItemWidth; // @synthesize contentItemWidth=_contentItemWidth;
...
- (double)_trendItemWidth;
- (void)setContentItemWidth:(double)arg1;
