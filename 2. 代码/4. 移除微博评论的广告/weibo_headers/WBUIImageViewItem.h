...
@interface WBUIImageViewItem : WBUIViewItem
{
    long long _drawMode;
    _Bool _highlighted;
    _Bool _isTilePattern;
    double _imageWHScale;
    UIImage *_highlightedImage;
    UIImage *_image;
}

@property(nonatomic) _Bool isTilePattern; // @synthesize isTilePattern=_isTilePattern;
...
@property(nonatomic) double imageWHScale; // @synthesize imageWHScale=_imageWHScale;
- (void).cxx_destruct;
