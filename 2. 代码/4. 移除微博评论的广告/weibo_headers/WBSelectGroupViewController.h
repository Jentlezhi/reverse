...
@class NSArray, NSDictionary, NSMutableArray, NSString, UIButton, WBSelectGroupSuperTopic;
@protocol WBSelectGroupViewControllerDelegate, WeiboCubeWeiyouDirectionalGroupProtocol;
...
@interface WBSelectGroupViewController : WBTableViewController <WBContactPickerViewControllerDelegate, PRLMTableViewWrapperDelegate>
{
    ...
    id <WeiboCubeWeiyouDirectionalGroupProtocol> _selectedGroup;
...
@property(retain, nonatomic) id <WeiboCubeWeiyouDirectionalGroupProtocol> selectedGroup; // @synthesize selectedGroup=_selectedGroup;
...
- (void)authenticationButtonPress;
- (void)configAuthButtonSubviewsWithTitle:(id)arg1 hasImage:(_Bool)arg2;
...
- (id)initWithSelectedGroup:(id)arg1 type:(unsigned long long)arg2 Topic:(id)arg3 authenticationType:(unsigned long long)arg4;
