...
@class UIButton, UIImageView, UILabel, WBCommonButtonStylePageCardView, WBContentImageView, WBLoadMoreFooterView;
...
@property(nonatomic) int arrowType; // @synthesize arrowType=_arrowType;
