...
- (_Bool)connectWWANWithAddress4:(id)arg1 address6:(id)arg2 error:(id *)arg3;
- (struct SSLContext *)sslContext;
...
- (void)dealloc;
- (id)initWithDelegate:(id)arg1 delegateQueue:(id)arg2 socketQueue:(id)arg3 isWifiConnectWithWWAN:(_Bool)arg4;
