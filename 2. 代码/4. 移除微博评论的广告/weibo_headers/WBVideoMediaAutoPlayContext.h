...
@class NSString, WBVideoPlayerController, WBVideoPrefetchManager;
@protocol WBMediaCacheManaging, WBMediaResourcePrefetching;

@interface WBVideoMediaAutoPlayContext : NSObject <WBMediaAutoPlayContext>
{
    WBVideoPrefetchManager *_prefetchManager;
