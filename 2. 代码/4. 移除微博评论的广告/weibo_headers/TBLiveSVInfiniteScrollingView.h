...
@class NSMutableArray, TBLiveAnimationView, UIActivityIndicatorView, UIScrollView;

@interface TBLiveSVInfiniteScrollingView : UIView
{
    _Bool _enabled;
    ...
    TBLiveAnimationView *_animationView;
}

@property(retain, nonatomic) TBLiveAnimationView *animationView; // @synthesize animationView=_animationView;
