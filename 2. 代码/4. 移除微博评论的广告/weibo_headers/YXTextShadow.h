...
@interface YXTextShadow : NSObject <NSCoding, NSCopying>
{
    int _blendMode;
    UIColor *_color;
    double _radius;
    YXTextShadow *_subShadow;
...
@property(retain, nonatomic) YXTextShadow *subShadow; // @synthesize subShadow=_subShadow;
