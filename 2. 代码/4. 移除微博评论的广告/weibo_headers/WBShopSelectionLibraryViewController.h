...
@class NSArray, NSMutableDictionary, NSString, SNHTTPRequestOperationWrapper, UILabel, UIView, WBPRLMTableViewWrapper, WBSearchBar, WBTableView;

@interface WBShopSelectionLibraryViewController : WBViewController <UITableViewDelegate, UITableViewDataSource, PRLMTableViewWrapperDelegate, UISearchBarDelegate>
{
    ...
    NSMutableDictionary *_selectionProducts;
    NSArray *_keyArray;
    long long _page;
}
...
@property(retain, nonatomic) NSMutableDictionary *selectionProducts; // @synthesize selectionProducts=_selectionProducts;
