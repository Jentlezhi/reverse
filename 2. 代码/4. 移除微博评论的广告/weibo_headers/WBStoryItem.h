...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, WBPromotion, WBStoryItemStyle, WBStoryUser, WBStoryViewModel;
...
@interface WBStoryItem : WBModelObject
{
    ...
    NSString *_trendImageCoverURL;
    unsigned long long _tagStyle;
}

+ (id)itemsFromSegments:(id)arg1;
...
@property(copy, nonatomic) NSString *trendImageCoverURL; // @synthesize trendImageCoverURL=_trendImageCoverURL;
...
- (_Bool)canDeleteSegment:(id)arg1 featureCode:(id)arg2;
...
- (_Bool)shouldShowMoreButton:(id)arg1 providerType:(long long)arg2 featureCode:(id)arg3;
- (_Bool)shouldShowUserView;
@property(retain, nonatomic) WBStoryViewModel *viewModel;
