...
+ (id)extractPropertyNamesOfJSValueObject:(id)arg1;
+ (long long)getUnixFixTimeMillis;
...
+ (id)getDeviceID;
+ (_Bool)enableRTLLayoutDirection;
+ (void)setEnableRTLLayoutDirection:(_Bool)arg1;
...
+ (id)getEnvironment;
+ (unsigned long long)getEnvLayoutDirection;
