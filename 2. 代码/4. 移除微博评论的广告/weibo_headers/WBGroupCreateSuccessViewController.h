...
@property(nonatomic) _Bool isShareToWeibo; // @synthesize isShareToWeibo=_isShareToWeibo;
...
- (void)shareToWeiboBoxChecked;
- (void)onActionButtonPressed:(id)arg1;
- (void)onCompleteAction:(id)arg1;
- (void)selectShareButton:(id)arg1;
...
- (id)bottomButtonViewWithFrame:(struct CGRect)arg1;
- (void)refreshShareButton:(id)arg1;
- (id)bottomShareViewWithFrame:(struct CGRect)arg1;
- (void)viewDidLoad;
