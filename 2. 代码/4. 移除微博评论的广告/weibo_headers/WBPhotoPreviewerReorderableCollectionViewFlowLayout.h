...
@protocol WBPhotoPreviewerReorderableCollectionViewDataSource, WBPhotoPreviewerReorderableCollectionViewDelegateFlowLayout;

@interface WBPhotoPreviewerReorderableCollectionViewFlowLayout : UICollectionViewFlowLayout <UIGestureRecognizerDelegate>
{
...
@property(readonly, nonatomic) id <WBPhotoPreviewerReorderableCollectionViewDelegateFlowLayout> delegate;
@property(readonly, nonatomic) id <WBPhotoPreviewerReorderableCollectionViewDataSource> dataSource;
