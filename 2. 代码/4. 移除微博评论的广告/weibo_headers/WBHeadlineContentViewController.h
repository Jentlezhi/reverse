...
@class NSArray, NSIndexPath, NSMutableDictionary, NSString, WBRecycleScrollView, WBTableView, WBUniversalArticle;
...
@property(copy, nonatomic) NSArray *pragraphModelArray; // @synthesize pragraphModelArray=_pragraphModelArray;
@property(nonatomic) _Bool isUsedCompose; // @synthesize isUsedCompose=_isUsedCompose;
...
- (void).cxx_destruct;
- (void)updatePragraphModelArray:(id)arg1;
...
- (void)didTapArticleDCILink:(id)arg1;
- (void)didArticleReadMoreTapAnalysis;
- (void)didArticleReadMoreHandleScheme:(id)arg1;
...
- (void)recycleScrollViewReloadData;
