...
@interface CKEffectFilter : CKEffectOutput <WBGPUImageEffectDelegate>
{
...
+ (id)fileterWithType:(unsigned long long)arg1;
@property(nonatomic) unsigned long long effectType; // @synthesize effectType=_effectType;
- (void).cxx_destruct;
- (void)updateEffectType:(unsigned long long)arg1;
- (id)currentFrame;
