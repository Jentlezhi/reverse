...
@interface YXGoLivePreviewViewController : YXLiveViewController <YXWBNLPublishViewControllerDelegate, YXGoLiveViewModelDelegate, WBNLPublishViewControllerDelegate, YXWBNLFinishViewControllerDelegate>
{
    _Bool _publishMirrorEnable;
    _Bool _hasOccupyCamera;
    _Bool _isCreatedLive;
    _Bool _isLoginSuccess;
    _Bool _localTokenExpired;
...
+ (id)performer;
@property(nonatomic) _Bool localTokenExpired; // @synthesize localTokenExpired=_localTokenExpired;
...
- (void)resumePublish;
- (void)refreshLocalTokenInfoNeeded:(id)arg1;
