...
@interface WBTimelineRankListCardEntranceModel : WBModelObject <WBMediaExposureItemType>
{
    NSString *_title;
    NSString *_version;
    NSString *_scheme;
    ...
    NSString *_color_start;
    NSString *_color_end;
    NSString *_icon;
}

@property(retain, nonatomic) NSString *icon; // @synthesize icon=_icon;
@property(retain, nonatomic) NSString *color_end; // @synthesize color_end=_color_end;
@property(retain, nonatomic) NSString *color_start; // @synthesize color_start=_color_start;
