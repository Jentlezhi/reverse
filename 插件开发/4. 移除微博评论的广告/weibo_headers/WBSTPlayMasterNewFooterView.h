...
@class NSString, UIButton, UIImageView, UILabel, UIView, WBStoryFullScreenProgressView, WBStoryProgressView, WBStoryUserView;

@interface WBSTPlayMasterNewFooterView : WBSTPlayFooterBaseView <WBStoryFullScreenFooterContainerDelegate>
{
