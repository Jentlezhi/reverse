...
@class NSString, UIButton, WBNewStoryVideoContainerView, WBStoryItemSegment, WBStoryProgressImageView, WBStoryRingView, WBStoryVideoPlayerController;
@protocol WBStoryVideoPlayerViewDelegate;

@interface WBNewStoryVideoView : UIView <WBVideoPlayerControllerDelegate, WBStoryProgressImageViewDelegate, WBStoryVideoPlayerControllerDelegate, WBStoryMediaPlayerViewType>
{
    ...
    WBNewStoryVideoContainerView *_videoContainerView;
...
@property(retain, nonatomic) WBNewStoryVideoContainerView *videoContainerView; // @synthesize videoContainerView=_videoContainerView;
