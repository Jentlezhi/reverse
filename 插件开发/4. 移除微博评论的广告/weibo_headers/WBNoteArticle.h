...
@interface WBNoteArticle : NSObject
{
    ...
    NSString *_noteSetReadAuthority;
    NSString *_isNewUIStyle;
}

@property(copy, nonatomic) NSString *isNewUIStyle; // @synthesize isNewUIStyle=_isNewUIStyle;
@property(copy, nonatomic) NSString *noteSetReadAuthority; // @synthesize noteSetReadAuthority=_noteSetReadAuthority;
