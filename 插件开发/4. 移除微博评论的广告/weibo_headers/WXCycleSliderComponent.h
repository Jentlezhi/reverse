...
#import "WXIndicatorComponentDelegate-Protocol.h"
#import "WXRecycleSliderViewDelegate-Protocol.h"
...
@property(nonatomic) _Bool forbidSlideAnimation; // @synthesize forbidSlideAnimation=_forbidSlideAnimation;
...
@property(nonatomic) __weak WXRecycleSliderView *recycleSliderView; // @synthesize recycleSliderView=_recycleSliderView;
- (void).cxx_destruct;
