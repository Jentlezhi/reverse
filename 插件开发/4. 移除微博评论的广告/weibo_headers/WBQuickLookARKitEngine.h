...
@protocol WBQuickLookARKitEngineDelegate;

@interface WBQuickLookARKitEngine : NSObject <UIGestureRecognizerDelegate>
{
    UIView *_gestureView;
    _Bool _isPaning;
    ARSession *_session;
    id <WBQuickLookARKitEngineDelegate> _delegate;
    double _standardZ;
...
@property(nonatomic) __weak id <WBQuickLookARKitEngineDelegate> delegate; // @synthesize delegate=_delegate;
