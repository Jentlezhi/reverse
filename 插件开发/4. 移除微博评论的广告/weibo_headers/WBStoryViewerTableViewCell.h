...
@class UIImageView, UILabel, UIView, WBStoryImageURLButton, WBStoryUserView, WBStoryViewer;
...
@interface WBStoryViewerTableViewCell : WBTableViewCell
{
    ...
    UILabel *_fromLabel;
    WBStoryImageURLButton *_fromButton;
}

@property(retain, nonatomic) WBStoryImageURLButton *fromButton; // @synthesize fromButton=_fromButton;
