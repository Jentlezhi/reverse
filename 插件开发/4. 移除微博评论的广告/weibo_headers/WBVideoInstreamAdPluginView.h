...
@class NSDictionary, NSOrderedSet, NSString, WBStatus, WBTimelinePageInfo, WBVideoInstreamAdController;
...
- (_Bool)instreamAdControllerAllowShowControlsWhenInline:(id)arg1;
