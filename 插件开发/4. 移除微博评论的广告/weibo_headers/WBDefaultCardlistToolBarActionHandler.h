...
- (void)doNormalFollowCheckForButtonModel:(id)arg1 baseVC:(id)arg2;
- (void)doSTFollowCheckForButtonView:(id)arg1 buttonModel:(id)arg2;
...
- (void)followorUnfollowCardListWithButtonModel:(id)arg1 completion:(CDUnknownBlockType)arg2;
