...
@class NSArray, NSAttributedString, NSSet, YXTextContainer, YXTextLine;

@interface YXTextLayout : NSObject <NSCoding>
{
    ...
    YXTextContainer *_container;
    NSAttributedString *_text;
    struct __CTFramesetter *_frameSetter;
    struct __CTFrame *_frame;
    NSArray *_lines;
    YXTextLine *_truncatedLine;
...
@property(retain, nonatomic) YXTextLine *truncatedLine; // @synthesize truncatedLine=_truncatedLine;
...
@property(retain, nonatomic) YXTextContainer *container; // @synthesize container=_container;
- (void).cxx_destruct;
