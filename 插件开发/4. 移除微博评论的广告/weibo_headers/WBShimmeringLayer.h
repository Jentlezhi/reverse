...
@class NSString, WBShimmeringMaskLayer;

@interface WBShimmeringLayer : CALayer <WBShimmering>
{
    CALayer *_contentLayer;
    WBShimmeringMaskLayer *_maskLayer;
    _Bool _shimmering;
...
@property(retain, nonatomic) WBShimmeringMaskLayer *maskLayer; // @synthesize maskLayer=_maskLayer;
