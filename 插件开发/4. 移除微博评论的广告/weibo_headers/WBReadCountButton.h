...
@class UIImageView, WBStrokeLabel;

@interface WBReadCountButton : WBButton
{
    WBStrokeLabel *countLabel;
    WBStrokeLabel *promptLabel;
...
@property(retain, nonatomic) WBStrokeLabel *promptLabel; // @synthesize promptLabel;
@property(retain, nonatomic) WBStrokeLabel *countLabel; // @synthesize countLabel;
- (void).cxx_destruct;
