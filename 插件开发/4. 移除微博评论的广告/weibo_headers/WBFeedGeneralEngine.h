...
@interface WBFeedGeneralEngine : NSObject
{
}

+ (void)removeStatusTagWithParams:(id)arg1;
+ (id)getRecommendUserCardsWithParams:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
+ (void)silentRemoveTrends:(id)arg1 needSendHttpRequest:(_Bool)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
...
+ (id)unfollowUserWithUserID:(id)arg1 completion:(CDUnknownBlockType)arg2;
