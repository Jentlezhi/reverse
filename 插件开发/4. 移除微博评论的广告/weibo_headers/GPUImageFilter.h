...
@interface GPUImageFilter : GPUImageOutput <GPUImageInput>
{
    ...
    int oriInputTextureUniform;
    unsigned int oriTexture;
    _Bool hasOriginPic;
...
- (unsigned int)setFloat:(float)arg1 forUniformName:(id)arg2;
- (unsigned int)setInteger:(int)arg1 forUniformName:(id)arg2;
...
- (void)setOriTexture:(unsigned int)arg1;
- (void)setHasOrigin:(_Bool)arg1;
