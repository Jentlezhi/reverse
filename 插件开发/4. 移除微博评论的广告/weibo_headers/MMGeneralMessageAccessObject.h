...
- (_Bool)_sortChatsWithChat1:(id)arg1 chat2:(id)arg2;
...
- (_Bool)clearUnreadCountForAllChats;
...
- (id)extraWithAttachment:(id)arg1;
- (_Bool)updateAttachmentFidAndExtra:(id)arg1 forMessage:(id)arg2;
- (_Bool)updateAttachmentExtra:(id)arg1 forMessage:(id)arg2;
...
- (_Bool)updateFansGroupParentId:(long long)arg1 conversationType:(int)arg2 forChat:(long long)arg3;
...
- (long long)queryRemindTypeWithGroupId:(long long)arg1;
