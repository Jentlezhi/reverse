...
@interface WBTDAFHTTPClient : NSObject <NSCoding, NSCopying>
{
...
+ (id)clientWithBaseURL:(id)arg1 andModule:(id)arg2;
...
- (id)requestWithMethod:(id)arg1 path:(id)arg2 parameters:(id)arg3 parameterEncoding:(int)arg4;
