...
@interface WBShopTaobaoViewController : WBViewController <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, PRLMTableViewWrapperDelegate>
{
    unsigned long long page;
    _Bool _shouldCheckBindStatus;
    ...
    NSArray *_products;
    WBShopCustomButton *_shareBtn;
    WBShopCustomButton *_unbindBtn;
    SNHTTPRequestOperationWrapper *_operationWrapper;
}

@property(nonatomic) _Bool shouldCheckBindStatus; // @synthesize shouldCheckBindStatus=_shouldCheckBindStatus;
@property(retain, nonatomic) SNHTTPRequestOperationWrapper *operationWrapper; // @synthesize operationWrapper=_operationWrapper;
@property(retain, nonatomic) WBShopCustomButton *unbindBtn; // @synthesize unbindBtn=_unbindBtn;
@property(retain, nonatomic) WBShopCustomButton *shareBtn; // @synthesize shareBtn=_shareBtn;
