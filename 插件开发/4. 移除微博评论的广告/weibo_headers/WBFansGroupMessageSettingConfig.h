...
@interface WBFansGroupMessageSettingConfig : NSObject <WBMessageSettingConfigProtocol>
{
    _Bool _enable;
    _Bool _enableCreateFansGroup;
...
@property(nonatomic) _Bool enableCreateFansGroup; // @synthesize enableCreateFansGroup=_enableCreateFansGroup;
