...
@class NSMutableData, NSMutableURLRequest;

@interface WBMultipartFormData : NSObject <WBTDAFMultipartFormData>
{
...
@property(retain, nonatomic) NSMutableData *bodyData; // @synthesize bodyData=_bodyData;
