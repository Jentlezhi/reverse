...
@class NSError, NSString, WBFAsset, WBFPlayerAdaptationSelection;

@protocol WBFAssetInternalDelegate <NSObject>
- (void)asset:(WBFAsset *)arg1 didUpdateAdaptationSelection:(WBFPlayerAdaptationSelection *)arg2;
...
- (void)assetDidCompleteSeeking:(WBFAsset *)arg1 seekId:(int)arg2;
