...
@property(retain, nonatomic) NSString *giverate; // @synthesize giverate=_giverate;
...
@property(nonatomic) _Bool isShowSleinfo; // @synthesize isShowSleinfo=_isShowSleinfo;
