...
@class NSString, WBVideoInstreamAdControlsPluginView, WBVideoInstreamAdCountDownPluginView, WBVideoPlayerController;

@interface WBVideoInstreamAdPlaybackController : WBVideoCommonPlayerController <WBVideoPlayerLogManagerDelegate, WBVideoPlaybackEventListener>
{
    _Bool _prebuffering;
...
- (id)currentFullscreenViewController;
