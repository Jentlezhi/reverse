...
@class NSArray, NSDictionary, NSString, WBSTCardHeaderMediaInfo, WBStoryAggregateShareInfo, WBStoryUser;

@interface WBSTCardHeaderModel : WBModelObject
{
    _Bool _enableMusicFavirote;
    NSString *_itemID;
    NSString *_nickName;
    long long _useConut;
    NSString *_btnText;
...
@property(nonatomic) _Bool enableMusicFavirote; // @synthesize enableMusicFavirote=_enableMusicFavirote;
