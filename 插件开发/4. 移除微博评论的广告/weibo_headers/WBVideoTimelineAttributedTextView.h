...
@interface WBVideoTimelineAttributedTextView : WBTimelineAttributedTextView <WBTextLayoutDelegate>
{
    _Bool _expanded;
    _Bool _expandable;
    _Bool _alwaysShowPlaceholderBtn;
    _Bool _unHighlightWhenPressActiveRange;
...
@property(nonatomic) _Bool unHighlightWhenPressActiveRange; // @synthesize unHighlightWhenPressActiveRange=_unHighlightWhenPressActiveRange;
...
@property(nonatomic) _Bool alwaysShowPlaceholderBtn; // @synthesize alwaysShowPlaceholderBtn=_alwaysShowPlaceholderBtn;
