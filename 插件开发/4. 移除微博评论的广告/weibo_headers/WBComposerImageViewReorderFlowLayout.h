...
@protocol WBComposerImagesViewDataSource, WBComposerImagesViewDelegateFlowLayout;

@interface WBComposerImageViewReorderFlowLayout : UICollectionViewFlowLayout <UIGestureRecognizerDelegate>
{
...
@property(readonly, nonatomic) id <WBComposerImagesViewDelegateFlowLayout> delegate;
@property(readonly, nonatomic) id <WBComposerImagesViewDataSource> dataSource;
