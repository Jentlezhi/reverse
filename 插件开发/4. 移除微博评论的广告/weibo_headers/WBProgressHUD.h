...
@class NSAttributedString, NSString, UIButton, UIImage, WBProgressHUDView;
...
@property(retain, nonatomic) WBProgressHUDView *HUDView; // @synthesize HUDView=_HUDView;
