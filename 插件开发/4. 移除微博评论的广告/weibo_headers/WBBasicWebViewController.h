...
@class MKMapView, NSArray, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSString, NSURL, NSURLRequest, UIBarButtonItem, WBAlipayWebViewJavascriptBridge, WBCustomActionSheet, WBCustomActionSheetItem, WBWebDocumentSession, WBWebView, WBWebViewConsole, WBWebViewJSBridge, WBWebViewObjectHeaderView, WBWebViewURLActionManager, WBWebViewUserSettings;

@interface WBBasicWebViewController : WBViewController <WBWBDownloadURLSessionDelegate, WBJSBridgeDebugDelegate, MKMapViewDelegate, UIGestureRecognizerDelegate, WBWebViewDelegate>
{
    struct {
...
@property(nonatomic) _Bool allowRedirect; // @synthesize allowRedirect=_allowRedirect;
@property(nonatomic) _Bool disableInterception; // @synthesize disableInterception=_disableInterception;
@property(retain, nonatomic) NSString *markScheme; // @synthesize markScheme=_markScheme;
...
@property(retain, nonatomic) NSMutableArray *linksArray; // @synthesize linksArray=_linksArray;
...
- (void)reloadByResetWKHttpCookie;
- (void)reload;
- (void)goForward;
- (void)goBack;
- (void)updateControls;
- (void)setNeedsUpdateControls;
@property(readonly, nonatomic) unsigned long long coreType;
...
- (void)viewDidLoad;
- (void)configMarkIdFlagsWithURL:(id)arg1 parameters:(id)arg2;
...
- (void)dealloc;
- (id)combindLinkUrls;
- (void)analysis_ad_jumpTime:(id)arg1;
- (void)analysis_ad_finishTime;
- (void)analysis_ad_beginTime:(long long)arg1 redirectTime:(long long)arg2 type:(unsigned long long)arg3 jumpUrl:(id)arg4;
- (void)analysis_ad_markId;
- (void)analysisForWebViewDidFinishedLoading:(id)arg1;
- (void)analysisForWebViewDidStartLoading:(id)arg1;
- (id)currentNetworkType;
- (void)analysisForWebViewCache;
...
- (_Bool)loadLocalSource;
- (void)setLoadLocalSource:(_Bool)arg1;
- (id)ajaxURL;
