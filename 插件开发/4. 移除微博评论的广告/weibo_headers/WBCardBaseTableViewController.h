...
@class NSArray, NSMutableDictionary, NSSet, NSString, WBCardlistToolBarContainerView, WBCellShowingTimeChecker, WBMenuListPopoverView, WBPRLMTableViewWrapper, WBPageEngine, WBPageInfoFooterView, WBProgressHUD;

@interface WBCardBaseTableViewController : WBTableViewController <WBVideoPrefetchDataSource, WBComposeViewControllerDelegate, WBCellShowingTimeCheckerDelegate, WBPageEngineDelegate, PRLMTableViewWrapperDelegate, WBPageCardTableViewCellProtocol, WBToolBarMenuDelegate, WBMenuListPopoverViewDelegate, WBCardListBaseItemHeightContext, WBCardlistToolBarContainerViewDelegate, WBPageInfoFooterDelegate>
{
    ...
    NSSet *_guestForbideenSpecificCardItemIDSet;
    _Bool hasLoged;
    NSString *sinceId;
    _Bool sinceIDMode;
    _Bool hasLogedViews;
...
- (void)pageInfoFooterRightButtonDidPreseed:(id)arg1;
- (void)pageInfoFooterViewDidPreseed:(id)arg1;
...
- (void)multiUserSevenCardFollowNotification:(id)arg1;
- (_Bool)logIfNeed;
- (_Bool)isCardTypeForbiddenForGuest:(unsigned long long)arg1;
- (_Bool)isSpecificCardForbiddenForGuest:(unsigned long long)arg1;
...
- (void)requestPositiveRecomObj:(id)arg1 card:(id)arg2 ActionType:(int)arg3 cell:(id)arg4 exparams:(id)arg5;
...
- (_Bool)didPressResponder:(id)arg1 ofType:(unsigned long long)arg2 andCommonID:(id)arg3 inView:(id)arg4 userInfo:(id)arg5 withCard:(id)arg6 cell:(id)arg7;
...
- (void)configFooterTips:(id)arg1 useBaseVCData:(_Bool)arg2;
- (void)configFooterTips;
