...
@class NSArray, NSString, UIBarButtonItem, UIView, WBApplistGridView, WBContact, WBIndicatorView, WBPage, WBPageEngine, WBPageInfoHeaderView, WBPopoverWindow, WBTimeRecorder;

@interface WBUniversalPageViewController : WBCardBaseTableViewController <WBPageInfoHeaderViewDelegate, WBTimeRecorderProtocol, WBContactMessageViewControllerDelegate, SNPopoverWindowDismissDelegate, WBApplistGridViewDelegate, WBContactRecentPickerViewControllerDelegate>
{
    WBPage *page;
...
- (void)pageInfoViewDidPressDescButton:(id)arg1 sender:(id)arg2;
