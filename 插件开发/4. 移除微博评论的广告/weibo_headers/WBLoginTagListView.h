...
- (void)tagGroupOfOneTagViewColorSetting:(id)arg1 withisSelected:(_Bool)arg2;
- (void)secondTagViewColorSetting:(id)arg1 withisSelected:(_Bool)arg2;
- (void)firstTagViewColorSetting:(id)arg1 withisSelected:(_Bool)arg2;
- (void)tagViewColorSetting:(id)arg1 withisSelected:(_Bool)arg2;
- (id)touchUpTagViewColorNewSetting:(id)arg1 withGroup:(id)arg2 withisSelected:(_Bool)arg3;
- (id)tagViewColorNewSetting:(id)arg1 withGroup:(id)arg2 withisSelected:(_Bool)arg3;
- (void)dealloc;
