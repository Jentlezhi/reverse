...
@class NSDictionary, NSString, UIView, WBAdVideoNavigationBar, WBVideoItem, WBVideoPlaybackTransitionManager, WBVideoStorePlayerController, WBVideoStorePlayerView;
@protocol WBVideoPlayerSourceView;

@interface WBVideoCardlistViewController : WBCardListViewController <WBVideoPlayerControllerDelegate, WBVideoStorePlayerControllerDelegate, WBVideoPlaybackTransitionManagerDelegate, WBAdVideoNavigationBarDelegate, UIViewControllerTransitioningDelegate>
{
    struct {
