...
@class NSString, NSTimer, UIButton, UISlider, WBVideoControlsIndicatorView, WBVideoControlsProgressView, WBVideoGradientColorView, WBVideoPluginResolutionButtonItemResolver;
@protocol WBVideoOverlayControlsPluginViewDelegate;

@interface WBVideoOverlayControlsPluginView : WBVideoPluginBaseView <UIGestureRecognizerDelegate, WBVideoControlsProgressViewDelegate, WBVideoPlaybackMediaSelectionEventListener, WBVideoPluginResolutionButtonItemResolverEventListener>
{
    ...
    _Bool _shouldHideFullScreenBtn;
    _Bool _isDarkMode;
    _Bool _seeking;
    _Bool _showSystemVolumeView;
    _Bool _isHUDShowing;
    _Bool _videoDefChanging;
    _Bool _fixMoreHiddenDisable;
...
@property(nonatomic) _Bool fixMoreHiddenDisable; // @synthesize fixMoreHiddenDisable=_fixMoreHiddenDisable;
...
@property(nonatomic) _Bool shouldHideFullScreenBtn; // @synthesize shouldHideFullScreenBtn=_shouldHideFullScreenBtn;
...
- (void)videoControlsProgressViewDidUpdateHeight:(id)arg1;
...
- (void)updatePlaySpeedButton;
- (_Bool)_shouldShowPlaySpeedButton;
- (void)updateResolutionButton;
- (_Bool)_shouldShowResolutionButton;
...
- (double)currentProgressBarVisibleHeight;
- (void)layoutSubviews;
