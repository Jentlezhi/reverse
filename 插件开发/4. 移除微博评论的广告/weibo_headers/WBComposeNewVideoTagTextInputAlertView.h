...
@protocol WBComposeNewVideoTagTextInputAlertViewDelegate;

@interface WBComposeNewVideoTagTextInputAlertView : WBCustomTextInputModalView <WBCustomTextInputModalViewDelegate>
{
...
@property(nonatomic) __weak id <WBComposeNewVideoTagTextInputAlertViewDelegate> delegate;
