...
@class UIButton;
@protocol WBShortVideoControlsPluginDelegate;

@interface WBShortVideoOverlayControlsPluginView : WBVideoOverlayControlsPluginView
{
    id <WBShortVideoControlsPluginDelegate> _shortVideoControlsPluginDelegate;
    UIButton *_nextVideoTips;
}

@property(retain, nonatomic) UIButton *nextVideoTips; // @synthesize nextVideoTips=_nextVideoTips;
@property(nonatomic) __weak id <WBShortVideoControlsPluginDelegate> shortVideoControlsPluginDelegate; // @synthesize shortVideoControlsPluginDelegate=_shortVideoControlsPluginDelegate;
- (void).cxx_destruct;
