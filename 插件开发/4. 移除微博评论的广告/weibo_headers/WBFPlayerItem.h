...
@protocol WBFAVMediaSelection, WBFPlayerItemInternalDelegate;
...
@property(nonatomic) int seekIdSeed; // @synthesize seekIdSeed=_seekIdSeed;
@property(nonatomic) int currentSeekId; // @synthesize currentSeekId=_currentSeekId;
...
- (void).cxx_destruct;
- (void)asset:(id)arg1 didUpdateAdaptationSelection:(id)arg2;
- (void)asset:(id)arg1 didUpdateVideoSize:(struct CGSize)arg2;
- (void)_completeSeeking;
- (void)assetDidCompleteSeeking:(id)arg1 seekId:(int)arg2;
...
@property(readonly, nonatomic) _Bool stalledSinceLastCall; // @synthesize stalledSinceLastCall=_stalledSinceLastCall;
