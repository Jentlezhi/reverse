...
@class NSMutableDictionary, NSString, WBTDFMDatabase, WBTDFMStatement;

@interface WBTDFMResultSet : NSObject
{
    WBTDFMDatabase *_parentDB;
    WBTDFMStatement *_statement;
    NSString *_query;
...
@property(retain) WBTDFMStatement *statement; // @synthesize statement=_statement;
