...
@interface YGLayout : NSObject
{
    ...
    struct YGNode *_node;
    id <YGLayoutContextProtocol> _view;
}

+ (void)initialize;
@property(readonly, nonatomic) __weak id <YGLayoutContextProtocol> view; // @synthesize view=_view;
...
- (id)initWithCotextProvider:(id)arg1;
