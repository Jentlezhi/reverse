...
@class NSDictionary, NSError, NSMutableArray, NSString, NSURL, WBVideoPlayerItemPlaybackLogEvent;
...
@interface WBVideoPlayerStateData : NSObject
{
    ...
    NSDictionary *_sourceViewPlaybackLogParameters;
    NSDictionary *_sourceViewPageInfoAnalysisParameters;
    NSDictionary *_videoItemPlaybackActionLog;
    NSString *_sourceViewIdentifier;
}

@property(copy, nonatomic) NSString *sourceViewIdentifier; // @synthesize sourceViewIdentifier=_sourceViewIdentifier;
@property(retain, nonatomic) NSDictionary *videoItemPlaybackActionLog; // @synthesize videoItemPlaybackActionLog=_videoItemPlaybackActionLog;
...
@property(retain, nonatomic) NSDictionary *sourceViewPlaybackLogParameters; // @synthesize sourceViewPlaybackLogParameters=_sourceViewPlaybackLogParameters;
