...
@class NSDate, NSString, SimplePing, TracerouteResult;

@interface SinaNetworkTracerouter : NSObject <SimplePingDelegate>
{
    SimplePing *pinger;
    NSDate *sendDate;
    long long ttl;
...
- (void)stop;
- (void)finish;
- (void)tracetouteHost:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)dealloc;
- (void)clear;
- (id)init;
