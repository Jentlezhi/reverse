...
@class NSDictionary, NSOrderedSet, NSString, UIImageView, WBStatus, WBTimelinePageInfo, WBVideoItem;
@protocol WBMediaPlaybackItem;

@interface WBXVideoSplashVideoView : UIView <WBVideoPlayerSourceView>
{
    WBVideoItem *_item;
    UIImageView *_bg;
}
