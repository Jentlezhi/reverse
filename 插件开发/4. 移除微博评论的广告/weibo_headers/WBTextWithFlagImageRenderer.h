...
@interface WBTextWithFlagImageRenderer : WBTextRenderer <WBTextLayoutDelegate>
{
    ...
    WBUITextAttachment *_rightAlignImageAttachment;
    double _lineOffsetX;
}

@property(nonatomic) double lineOffsetX; // @synthesize lineOffsetX=_lineOffsetX;
@property(retain, nonatomic) WBUITextAttachment *rightAlignImageAttachment; // @synthesize rightAlignImageAttachment=_rightAlignImageAttachment;
...
- (void)placeFlagAttachment:(id)arg1 inContext:(struct CGContext *)arg2 withLayoutLine:(id)arg3 alignLeft:(_Bool)arg4;
