...
+ (id)runningSlice;
@property(readonly, nonatomic) CDStruct_32a7f38a linkedSDKVersion; // @synthesize linkedSDKVersion=_linkedSDKVersion;
@property(readonly, nonatomic) CDStruct_32a7f38a minimumOSVersion; // @synthesize minimumOSVersion=_minimumOSVersion;
- (void).cxx_destruct;
