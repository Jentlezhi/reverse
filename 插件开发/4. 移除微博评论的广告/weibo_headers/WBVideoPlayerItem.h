...
@interface WBVideoPlayerItem : WBFPlayerItem <WBFAssetCacheDelegate, WBVideoPlayerItem>
{
    ...
    id _dnsHandlingNotificationObserver;
    id _httpdnsStartNotificationObserver;
    id _httpdnsFinishNotificationObserver;
}
...
@property(retain, nonatomic) id httpdnsFinishNotificationObserver; // @synthesize httpdnsFinishNotificationObserver=_httpdnsFinishNotificationObserver;
@property(retain, nonatomic) id httpdnsStartNotificationObserver; // @synthesize httpdnsStartNotificationObserver=_httpdnsStartNotificationObserver;
@property(retain, nonatomic) id dnsHandlingNotificationObserver; // @synthesize dnsHandlingNotificationObserver=_dnsHandlingNotificationObserver;
...
- (void)httpdnsHostResolutionFinish:(id)arg1;
- (void)httpdnsHostResolutionStart:(id)arg1;
- (void)resourceLoaderDidPerformHostResolution:(id)arg1;
