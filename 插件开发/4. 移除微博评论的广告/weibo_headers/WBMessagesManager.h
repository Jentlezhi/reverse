...
@class MMGroupBulletinManager, MMUnreadMessageCount, MMUser, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, SNHTTPRequestOperationWrapper, WBProgressHUD, WBTDFMDatabaseQueue;
@protocol MMInteractiveMenuDelegate, MMSingleChatSettingsDelegate, OS_dispatch_semaphore;
...
@interface WBMessagesManager : NSObject
{
    ...
    _Bool _showDeleteAllTrashUsersButton;
    ...
    NSMutableDictionary *_conversationBoxMap;
    NSObject<OS_dispatch_semaphore> *_usersLock;
}
...
@property(retain, nonatomic) NSObject<OS_dispatch_semaphore> *usersLock; // @synthesize usersLock=_usersLock;
@property(nonatomic) _Bool showDeleteAllTrashUsersButton; // @synthesize showDeleteAllTrashUsersButton=_showDeleteAllTrashUsersButton;
@property(retain, nonatomic) NSMutableDictionary *conversationBoxMap; // @synthesize conversationBoxMap=_conversationBoxMap;
...
@property(retain, nonatomic) NSMutableSet *illegalFids; // @synthesize illegalFids=_illegalFids;
...
- (void).cxx_destruct;
- (void)batchAllGroupNotices:(id)arg1;
- (void)clearUserUnreadCountNotification:(id)arg1;
- (void)markGroupBulletinRead:(id)arg1;
- (void)clearChatUnreadCountNotRefreshUnreadMessageCount:(id)arg1;
- (void)refreshConversationUnreadCount:(id)arg1;
- (void)clearCommentAtLikeUnreadCount:(id)arg1;
- (double)clearUnreadCountForGetReadStartTime;
- (void)clearUnreadCountForSetReadStartTime;
- (void)clearChatUnreadCountInDB;
- (void)clearChatUnreadCountInMemory:(id)arg1;
- (void)clearAllChatUnreadCountInMemoryAndDB;
- (void)oneKeyClearAllUnreadCount:(_Bool)arg1;
- (void)chatUnreadCountDidClearedWithChat:(id)arg1;
- (void)clearUnreadCountNotMessageChat:(id)arg1;
- (void)checkVideoFidsWithMessages:(id)arg1;
- (id)videoFidsWithMessages:(id)arg1;
- (void)checkAuditWithFids:(id)arg1;
- (_Bool)saveIllegalFids;
- (_Bool)updateIllegalFids:(id)arg1 inFids:(id)arg2;
- (void)loadIllegalFidsIfNeeded;
- (_Bool)loadIllegalFids;
- (id)illegalFidsPath;
- (_Bool)isIllegalFid:(id)arg1;
- (void)resendVideoMessage:(id)arg1;
- (void)cancelAllVideoMessages;
- (void)cancelVideoMessage:(id)arg1;
- (void)sendVideoMessage:(id)arg1;
- (void)queryRemoteNicknameWithGroupId:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
...
- (void)notifyVideoMessageReadWithUid:(long long)arg1 messages:(id)arg2 completedBlock:(CDUnknownBlockType)arg3;
...
- (_Bool)needNotifyReadMessageType:(int)arg1 originMsgType:(int)arg2;
...
- (id)queryMessages:(id)arg1 afterMsgId:(long long)arg2 offset:(int)arg3 limit:(int)arg4 userBlock:(CDUnknownBlockType)arg5 tabId:(int)arg6;
- (id)queryMessages:(id)arg1 afterMsgId:(long long)arg2 offset:(int)arg3 limit:(int)arg4 userBlock:(CDUnknownBlockType)arg5;
- (id)queryMessages:(id)arg1 beforeMsgId:(long long)arg2 offset:(int)arg3 limit:(int)arg4 userBlock:(CDUnknownBlockType)arg5 tabId:(int)arg6;
...
- (void)destoryGroup:(id)arg1 withExtraParameters:(id)arg2 successBlock:(CDUnknownBlockType)arg3 failureBlock:(CDUnknownBlockType)arg4;
- (void)dealGroupNoticeForApply:(long long)arg1 mid:(long long)arg2 affIUid:(long long)arg3 isAgree:(_Bool)arg4 withExtraParameters:(id)arg5 successBlock:(CDUnknownBlockType)arg6 failureBlock:(CDUnknownBlockType)arg7;
- (void)deleteGroupAffiliation:(id)arg1 isExist:(_Bool)arg2 withExtraParameters:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failureBlock:(CDUnknownBlockType)arg5;
- (void)deleteSchemeGuideConversation:(id)arg1;
...
- (void)deleteWithoutUpdateChat:(long long)arg1 chatType:(int)arg2;
- (void)deleteChat:(long long)arg1 chatType:(int)arg2;
- (void)removeLatestChat:(long long)arg1 type:(int)arg2;
- (void)setLatestChat:(long long)arg1 type:(int)arg2 time:(long long)arg3;
...
- (void)reloadChatListWithNewChats:(id)arg1;
- (void)reloadChatListWithNewChat:(id)arg1;
- (_Bool)chatNeedInsert:(id)arg1 newChat:(id)arg2;
...
- (void)setAccountAuth;
- (void)refreshMMCoreAccountAuthIfNeed;
- (void)tokenExpired;
...
- (void)clearGroupMessagesMemory;
- (void)clearGroupMessages;
- (void)clearSingleMessages;
- (void)clearSingleMessagesMemory;
- (void)updateConfigType:(long long)arg1 withVersion:(long long)arg2;
- (_Bool)bShowDeleteAllTrashUsersButton;
- (void)saveShowDeleteAllTrashUsersButton:(_Bool)arg1;
- (void)deleteLocalTrashUsersForMessageBoxListWithChatIds:(id)arg1;
- (void)updateMessageBoxFolderAtDeleteAllTrashUsers;
- (void)deleteAllTrashUsersForMessageBoxListWithCompletedBlock:(CDUnknownBlockType)arg1;
- (void)deleteLocalTrashUsersForUserListWithChatIds:(id)arg1;
- (void)deleteAllTrashUsersForUserListWithCompletedBlock:(CDUnknownBlockType)arg1;
- (id)queryTrashUserUidsWithType:(int)arg1;
- (void)schemeGuideActionWithId:(long long)arg1 actionType:(unsigned long long)arg2 completedBlcok:(CDUnknownBlockType)arg3;
