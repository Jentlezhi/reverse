...
@protocol OS_dispatch_semaphore, YXTextLinePositionModifier;

@interface YXTextContainer : NSObject <NSCoding, NSCopying>
{
    _Bool _readonly;
    ...
    id <YXTextLinePositionModifier> _linePositionModifier;
}
...
- (void).cxx_destruct;
@property(copy) id <YXTextLinePositionModifier> linePositionModifier;
