...
@class NSArray, NSString, UIControl, UIImage, WBSearchBar, WBTableView;
...
- (void)fetchSeachResultComplete:(CDUnknownBlockType)arg1;
...
- (void)searchViewConfigure;
- (void)drakSearchConfigure;
