...
@class NSString, WBCardListBaseItem, WBMLVideoInteractView;
@protocol WBHotWeiboSquareBottomViewDelegate, WBWebViewProtocol;

@interface WBMLVideoCommentViewController : WBTableViewController <WBSegmentChannelViewControllerProtocol>
{
