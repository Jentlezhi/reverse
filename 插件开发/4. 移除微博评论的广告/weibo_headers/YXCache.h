...
@class NSString, YXDiskCache, YXMemoryCache;
@protocol OS_dispatch_queue;

@interface YXCache : NSObject
{
    NSString *_name;
    NSObject<OS_dispatch_queue> *_queue;
    YXDiskCache *_diskCache;
    YXMemoryCache *_memoryCache;
}

+ (id)sharedCache;
@property(readonly) YXMemoryCache *memoryCache; // @synthesize memoryCache=_memoryCache;
@property(readonly) YXDiskCache *diskCache; // @synthesize diskCache=_diskCache;
