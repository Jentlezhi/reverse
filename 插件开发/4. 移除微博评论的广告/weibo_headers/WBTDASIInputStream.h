...
@class NSInputStream, NSString, WBTDASIHTTPRequest;
@protocol NSStreamDelegate;

@interface WBTDASIInputStream : NSObject <NSStreamDelegate>
{
...
+ (void)initialize;
@property(nonatomic) WBTDASIHTTPRequest *request; // @synthesize request;
