...
@class NSArray, NSString, UIActivityIndicatorView, UIButton, UICollectionView, UIImageView, UILabel, UITapGestureRecognizer, UIViewController, WBNLConductGuideListModel, WBNLLineLabelView, YXLiveUserView;
...
- (void).cxx_destruct;
- (void)followAnchorWithTriggerSender:(id)arg1;
- (_Bool)isVPlusType;
