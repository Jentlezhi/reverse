...
@class NSDictionary, NSOrderedSet, NSString, UIButton, UIImageView, WBStatus, WBTimelinePageInfo, WBVideoItem;
@protocol WBMediaPlaybackItem;

@interface WBShopWindowVideoView : UIView <WBVideoPlayerSourceView>
{
    WBVideoItem *_backItem;
...
@property(retain, nonatomic) WBVideoItem *backItem; // @synthesize backItem=_backItem;
- (void).cxx_destruct;
