...
@protocol WBScrollRefreshViewProtocol <NSObject>
@property(nonatomic) _Bool showPRLMHeaderWhenManuallySetContentOffset;
@property(nonatomic) double baseContentInsetTop;
@property(nonatomic) __weak WBScrollViewRefresh *refreshManager;
