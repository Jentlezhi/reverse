...
#import "MMAudioMessageCellDelegate-Protocol.h"
#import "MMCardMessageCellDelegate-Protocol.h"
#import "MMFileDownLoadViewControllerDelegate-Protocol.h"
#import "MMFileMessageCellDelegate-Protocol.h"
#import "MMFrequencyLimiterDelegate-Protocol.h"
#import "MMGroupTitleViewStatusDelegate-Protocol.h"
#import "MMMapMessageCellDelegate-Protocol.h"
...
#import "MMPhotoMessageCellDelegate-Protocol.h"
#import "MMStoryMessageCellDelegate-Protocol.h"
#import "MMTextMessageCellDelegate-Protocol.h"
#import "MMVideoMessageCellDelegate-Protocol.h"
...
#import "WeiboCubeMMBaseMessageViewControllerProtocol-Protocol.h"
#import "WeiboCubePhotoViewerDelegate-Protocol.h"

@class ALAssetsLibrary, CALayer, MMAudioPlayStateSwitchView, MMFrequencyLimiter, MMInputManager, MMMessage, MMMessageVideoPlayerController, MsgRemindBtnView, NSArray, NSDate, NSDictionary, NSIndexPath, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSTimer, UIAlertAction, UIBarButtonItem, UIButton, UIView, WBAlertController, WBAudioPlayer, WBContact, WBConversation, WBIndicatorView, WBMessage, WBMessageContentView, WBMessagePRLMTableViewWrapper, WBMessageSelectedView, WBMessagesTableHeaderView, WBProgressHUD, WBTimelinePageInfo, WBVideoPrefetchManager;

@interface MMBaseMessageViewController : WBTableViewController <UIGestureRecognizerDelegate, MMPageCardStatusWithCommentCellDelegate, MsgRemindBtnViewDelegate, WeiboCubePhotoViewerDelegate, WBVideoPlayerLogManagerDelegate, MMFileDownLoadViewControllerDelegate, MMMessageCellDelegateT, MMPhotoMessageCellDelegate, MMAudioMessageCellDelegate, MMMapMessageCellDelegate, MMCardMessageCellDelegate, MMTextMessageCellDelegate, MMStoryMessageCellDelegate, MMFileMessageCellDelegate, MMVideoMessageCellDelegate, MMGroupTitleViewStatusDelegate, WBCustomTextInputModalViewDelegate, WBContactMessageViewControllerDelegate, MIMessageViewController, MMFrequencyLimiterDelegate, PRLMTableViewWrapperDelegate, WBAudioPlayerDelegate, MMPageInfoWithCommentMessageCellDelegate, WeiboCubeMMBaseMessageViewControllerProtocol>
{
    ...
    _Bool _isLastReadMsgIDInfirstFetchMsg;
    int _chatType;
    int _refreshType;
    int _loadMoreType;
    long long _chatId;
    ...
    MMAudioPlayStateSwitchView *_audioHintView;
    ...
    MMMessageVideoPlayerController *_player;
    WBVideoPrefetchManager *_videoPrefetchManager;
    NSMutableDictionary *_addOneMessageCache;
    NSArray *_photoViewerMessages;
...
+ (void)uploadErrorLogWithMessage:(id)arg1;
+ (id)videoItemFromWBMessage:(id)arg1;
+ (id)videoItemFromMessage:(id)arg1;
@property(nonatomic) _Bool isLastReadMsgIDInfirstFetchMsg; // @synthesize isLastReadMsgIDInfirstFetchMsg=_isLastReadMsgIDInfirstFetchMsg;
...
@property(retain, nonatomic) NSArray *photoViewerMessages; // @synthesize photoViewerMessages=_photoViewerMessages;
@property(retain, nonatomic) NSMutableDictionary *addOneMessageCache; // @synthesize addOneMessageCache=_addOneMessageCache;
...
@property(retain, nonatomic) MMMessageVideoPlayerController *player; // @synthesize player=_player;
...
@property(retain, nonatomic) MMAudioPlayStateSwitchView *audioHintView; // @synthesize audioHintView=_audioHintView;
...
@property(nonatomic) _Bool showUnreadView; // @synthesize showUnreadView=_showUnreadView;
@property(nonatomic) unsigned long long messageFrom; // @synthesize messageFrom=_messageFrom;
...
@property(nonatomic) double remindButtonTopMargin; // @synthesize remindButtonTopMargin=_remindButtonTopMargin;
...
- (void).cxx_destruct;
- (_Bool)playerLogManager:(id)arg1 didCollectPlaybackSessionMetrics:(id)arg2;
- (void)videoPreparePlayMessage:(id)arg1 imageFrameInWindow:(struct CGRect)arg2 sourceView:(id)arg3 isFromCardlist:(_Bool)arg4;
- (void)videoButtonPressed:(id)arg1 message:(id)arg2 imageFrame:(struct CGRect)arg3 indexPath:(id)arg4;
- (void)recordingAreadyStop;
- (_Bool)needsTitleBarWhenPeeking;
- (_Bool)registersPeekingGesture;
- (_Bool)accessibilityPerformMagicTap;
- (void)highlightShowedMsgImportantThenRefresh;
- (void)checkShowedImportantMsgByTapThenRefresh;
...
- (void)sendVideoMessages:(id)arg1;
...
- (void)logAddoneClickWithMessage:(id)arg1;
- (void)didTapAddone:(id)arg1 message:(id)arg2;
...
- (void)shareImageWithMessage:(id)arg1;
- (void)photoViewer:(id)arg1 repostImageAtIndex:(long long)arg2;
- (void)photoViewerDidDismiss:(id)arg1;
- (void)photoViewerDidFinishLoadImage:(id)arg1;
...
- (void)preloadMessageVideos:(id)arg1;
...
- (void)configUnreadMsgBtnThenShow;
- (void)messageDidSuccessReloadWithAction:(int)arg1;
...
- (void)setAllSelects;
- (void)resetSelects;
- (_Bool)_canRecallOtherMessage:(id)arg1;
- (void)downInputView;
...
- (id)messageAddoneCached:(id)arg1;
- (void)cacheAddoneMessage:(id)arg1 withKey:(id)arg2;
- (void)removeOldestAddoneMessageForKey:(id)arg1;
- (_Bool)shouldMessageShowAddOne:(id)arg1 inMsgGroups:(id)arg2;
- (void)checkShowAddoneMessage:(id)arg1;
- (void)checkShowAddoneMessageForFetched:(id)arg1;
...
- (_Bool)isShowUnreadRemindView;
- (id)indexPathsForVisibleMessages;
- (id)importantMsgInfosWithData:(id)arg1;
- (_Bool)isInGroupsMessage:(id)arg1;
- (id)indexPathsForImportantMsgsForVisibleRows;
...
- (void)shareImageToFriends:(id)arg1;
...
- (_Bool)checkLastReadMidInFirstFetchMessages:(id)arg1;
