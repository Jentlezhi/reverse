...
@interface WBXAppConfiguration : NSObject
{
    NSString *_appGroup;
    NSString *_appName;
    ...
    unsigned long long _JSFrameworkLibSize;
...
+ (void)setJSFrameworkLibSize:(unsigned long long)arg1;
+ (unsigned long long)JSFrameworkLibSize;
...
@property(retain, nonatomic) NSString *lan; // @synthesize lan=_lan;
@property(retain, nonatomic) NSArray *customizeProtocolClasses; // @synthesize customizeProtocolClasses=_customizeProtocolClasses;
@property(nonatomic) unsigned long long JSFrameworkLibSize; // @synthesize JSFrameworkLibSize=_JSFrameworkLibSize;
