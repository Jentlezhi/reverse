...
@interface WBLaunchVideoDisplayView : UIView <WBVideoPlayerSourceView>
{
    id <WBMediaPlaybackItem> _mediaPlaybackItem;
}

@property(retain, nonatomic) id <WBMediaPlaybackItem> mediaPlaybackItem; // @synthesize mediaPlaybackItem=_mediaPlaybackItem;
- (void).cxx_destruct;
