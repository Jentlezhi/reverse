...
- (void)bottomOperationDidTapRecommendButton:(WBPhotoViewerBottomOperationView *)arg1;
- (void)bottomOperationView:(WBPhotoViewerBottomOperationView *)arg1 didTapPromotionView:(int)arg2;
- (void)bottomOperationView:(WBPhotoViewerBottomOperationView *)arg1 didExpandWeiboContent:(_Bool)arg2;
- (void)bottomOperationView:(WBPhotoViewerBottomOperationView *)arg1 willExpandWeiboContent:(_Bool)arg2;
...
- (void)bottomOperationView:(WBPhotoViewerBottomOperationView *)arg1 didTapCommentShare:(id)arg2;
