...
@class MPVolumeView, NSArray, NSDictionary, NSMutableArray, NSString, NSTimer, PRLMTableViewWrapper, SNHTTPRequestOperationWrapper, UIButton, UIView, WBContactEngine, WBMediaAutoPlayManager, WBStatus, WBTimeRecorder, WBVideoFeedNavigationBar, WBVideoPanToDismissInteractiveTransition, WBVideoPlaybackTransitionManager, WBVideoTimelinePlayerController, WBVideoTimelinePreviewContentView, WBVideoTimelineTableViewCell;
@protocol WBMediaPlaybackSourceView, WBVideoPlayerSourceView;

@interface WBVideoTimelineViewController : WBTableViewController <WBVideoTimelineTableViewCellDelegate, WBVideoUpNextPluginCountDownDelegate, UIViewControllerTransitioningDelegate, WBVideoTimelinePlayerControllerDelegate, UIGestureRecognizerDelegate, PRLMTableViewWrapperDelegate, WBVideoUpNextPluginViewVisibleDelegate, WBVideoTimelinePreviewContentViewDelegate, WBVideoPrefetchDataSource, WBVideoDismissInteractiveTransitionDelegate, WBTimeRecorderProtocol, WBVideoPlaybackSchemeAutoTransitioning>
{
