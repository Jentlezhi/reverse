...
@protocol UIViewControllerContextTransitioning, WBShortVideoTransitionDelegate;

@interface WBShortVideoTransitionManager : NSObject <UIGestureRecognizerDelegate, UIViewControllerAnimatedTransitioning, UIViewControllerInteractiveTransitioning, UIViewControllerTransitioningDelegate>
{
    _Bool _isInteractive;
    _Bool _isPresenting;
    _Bool _isDismissing;
    _Bool _pullingDown;
    id <WBShortVideoTransitionDelegate> _delegate;
...
@property(nonatomic) __weak id <WBShortVideoTransitionDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)doNoneInteractiveDismissAnimation:(id)arg1 duration:(double)arg2;
...
- (void)configPanGestureForView:(id)arg1;
