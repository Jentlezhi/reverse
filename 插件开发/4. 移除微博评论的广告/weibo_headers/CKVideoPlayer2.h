...
@protocol CKVideoPlayerDelegate2, CKVideoPlayerOutputDelegate2, OS_dispatch_queue;

@interface CKVideoPlayer2 : NSObject <AVPlayerItemOutputPullDelegate>
{
    ...
    _Bool _readyToPlay;
    double _rate;
    id <CKVideoPlayerOutputDelegate2> _outputDelegate;
    id <CKVideoPlayerDelegate2> _delegate;
...
@property(nonatomic) __weak id <CKVideoPlayerDelegate2> delegate; // @synthesize delegate=_delegate;
@property(readonly, nonatomic) __weak id <CKVideoPlayerOutputDelegate2> outputDelegate; // @synthesize outputDelegate=_outputDelegate;
- (void).cxx_destruct;
