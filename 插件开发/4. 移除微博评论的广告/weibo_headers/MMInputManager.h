...
@class ALAssetsLibrary, MMBaseMessageViewController, MMComposerAddonsView, MMInteractiveMenu, NSString, UIButton, UIView, WBALAssetPickerContextManager, WBAudioRecorderOverlayController, WBCameraAVExport, WBFunnyPictureView, WBMessagesInputView, WBNewEmoticonInputView, WBProgressHUD, WBTipQuickSendImage;

@interface MMInputManager : NSObject <WBAudioRecorderOverlayControllerDelegate, WBPhotoEditorViewControllerFakerDelegate, WBALAssetPickerContextManagerDelegate, WBMapLocationViewControllerDelegate, WBMessagesInputViewDelegate, WBRecordButtonDelegate, WBNewEmoticonInputViewDelegate, MMComposerAddonsViewDelegate, MMInteractiveMenuDelegate, WBFunnyPictureViewDelegate>
{
    _Bool _keyboardIsVisible;
    WBCameraAVExport *_cameraExport;
    _Bool _bAllowSwitchMenuAndInputView;
    _Bool _hasInteractiveMenu;
    _Bool _needPushAnimation;
    _Bool _shouldHideChangeButton;
    _Bool _dontDisableInteractionForInputView;
    _Bool _peeking;
    _Bool _isShowFansHintView;
    _Bool _isRuningAnimate;
    _Bool _isInputHide;
    _Bool _loadGif;
    _Bool _hasKeyboardObserver;
    _Bool _isInValidRecordRect;
    _Bool _isInputGroupAt;
    _Bool _bAtAllMembers;
...
@property(nonatomic) _Bool bAtAllMembers; // @synthesize bAtAllMembers=_bAtAllMembers;
...
@property(nonatomic) _Bool hasKeyboardObserver; // @synthesize hasKeyboardObserver=_hasKeyboardObserver;
...
@property(retain, nonatomic) UIButton *fansGroupHintButton; // @synthesize fansGroupHintButton=_fansGroupHintButton;
@property(nonatomic) _Bool isShowFansHintView; // @synthesize isShowFansHintView=_isShowFansHintView;
...
- (void).cxx_destruct;
- (void)removeFunnyPictureView;
- (struct CGSize)itemSizeInPictureView:(id)arg1;
- (long long)numberOfLineInPictureView:(id)arg1;
...
- (void)prepareFilePathByVideo:(id)arg1;
...
- (id)needSendVideoAttachments:(id)arg1;
...
- (void)didFinishPickerVideo:(id)arg1 progressView:(id)arg2;
...
- (void)showTipQuickSendImageViewWithPHAsset:(id)arg1;
...
- (void)menuEndSwtich;
- (void)menuBeginSwitch;
- (_Bool)menuShouldBeginSwitch;
- (void)moveDownMenu;
- (void)moveUpMenu;
...
- (void)interactiveMenu:(id)arg1 didSelectedPhoneNumber:(id)arg2;
...
- (void)prepareTableViewFrameForMode:(long long)arg1;
- (void)adjustTableViewFrameForMode:(long long)arg1;
...
- (id)transferNewModelsToOldDic:(id)arg1;
- (id)fetchLocalComposerAddons;
- (id)fetchComposerAddons;
- (id)fetchAddons;
- (void)showGif;
- (void)openSchemeWithType:(int)arg1 schemeUrl:(id)arg2;
- (void)takePicture:(int)arg1;
...
- (void)checkLastPhoto:(id)arg1 perform:(CDUnknownBlockType)arg2;
- (id)fetchLatestPhotoAsset;
