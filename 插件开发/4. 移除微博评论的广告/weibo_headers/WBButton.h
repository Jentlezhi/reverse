...
@class DynamicNode, NSMutableDictionary, NSString, UIImage, UILabel, WBButtonInfo;

@interface WBButton : WBUIControl <WBDynamicViewProtocol>
{
    NSString *renderedTitle;
    UIImage *renderedImage;
    UIImage *renderedBackgroundImage;
    UIImage *renderedAccessoryImage;
    ...
    struct {
        ...
        unsigned int accessoryImageChange;
    } _pending;
    ...
    struct CGRect _accessoryImageFrame;
...
@property(retain, nonatomic) UIImage *accessoryImages; // @synthesize accessoryImages=_accessoryImages;
...
@property(nonatomic) struct CGRect accessoryImageFrame; // @synthesize accessoryImageFrame=_accessoryImageFrame;
...
- (void)updateAccessoryImage:(id)arg1;
