...
@class UIControl, WBContactAddressBookContactsTipView, WBContactDataButton, WBStyleButton;
...
@interface WBContactAddressBookContactCell : WBContactContactsTableViewCell
{
    ...
    WBStyleButton *_removeButton;
}

@property(retain, nonatomic) WBStyleButton *removeButton; // @synthesize removeButton=_removeButton;
...
- (void)layoutSubviews;
- (void)showActionButton:(_Bool)arg1 title:(id)arg2;
