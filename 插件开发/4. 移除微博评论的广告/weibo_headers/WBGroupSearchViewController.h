...
@class MMSearchBar, NSMutableArray, NSString, WBContactEngine, WBContactGroup, WBDirectionalGroup;
@protocol WBGroupSearchViewControllerDelegate;

@interface WBGroupSearchViewController : WBTableViewController <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, WBContactContactsTableViewCellDelegate, WBTableViewDelegate>
{
    _Bool _isOwner;
    _Bool _isManager;
    _Bool _isSearch;
...
@property(retain, nonatomic) MMSearchBar *searchBar; // @synthesize searchBar;
...
- (void).cxx_destruct;
- (void)loadChatGroupSearchUserWithGroupID:(id)arg1 searchKey:(id)arg2 silence:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
