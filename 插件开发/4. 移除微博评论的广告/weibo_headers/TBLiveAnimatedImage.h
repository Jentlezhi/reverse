...
@class NSArray, NSData, NSIndexSet, NSMutableArray, NSMutableIndexSet, NSObject;
@protocol OS_dispatch_queue;

@interface TBLiveAnimatedImage : UIImage
{
    ...
    TBLiveAnimatedImage *_weakProxy;
}
...
+ (void)initialize;
@property(readonly, nonatomic) TBLiveAnimatedImage *weakProxy; // @synthesize weakProxy=_weakProxy;
...
@property(readonly, nonatomic) UIImage *firstFrameImg; // @synthesize firstFrameImg=_firstFrameImg;
...
- (id)predrawnImageAtIndex:(unsigned long long)arg1 forceDecode:(_Bool)arg2;
