...
+ (id)_groupOperationItemsWithGroup:(id)arg1 pageType:(long long)arg2;
...
+ (id)createQuiteSectionWithGroup:(id)arg1 memberType:(int)arg2;
+ (id)createClearSectionWithGroup:(id)arg1 memberType:(int)arg2;
+ (id)createSecondMiddleSectionWithGroup:(id)arg1 memberType:(int)arg2;
+ (id)createGroupMemberRankSectionWithGroup:(id)arg1 memberType:(int)arg2;
+ (id)createSearchChatHistorySectionWithGroup:(id)arg1 memberType:(int)arg2;
