...
@class NSMutableDictionary, NSString, UIButton, UIImageView, UIScrollView, WBContentImageView, WBTimelineTrendItem, WBTimelineTrendTitleView;

@interface WBTimelineTrendContainerView : UIView <WBTimelineTrendContentViewDelegate, UIScrollViewDelegate, WBPageCardBubbleViewDelegate, WBPageCardViewProtocol>
{
...
- (id)getDetailCardContentViewCurrentBubbleViewForScrollView:(id)arg1 PageCard:(id)arg2;
