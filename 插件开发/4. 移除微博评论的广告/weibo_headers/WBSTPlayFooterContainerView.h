...
@class NSString, UIButton, WBSTPlayFooterBaseView, WBSTPlayVideoVerticalOverlayView, WBStoryFullScreenProgressView, WBStoryUserView;
...
@interface WBSTPlayFooterContainerView : UIView
{
    ...
    WBSTPlayVideoVerticalOverlayView<WBStoryFullScreenFooterContainerDelegate> *_verticalOverlayView;
}

@property(retain, nonatomic) WBSTPlayVideoVerticalOverlayView<WBStoryFullScreenFooterContainerDelegate> *verticalOverlayView; // @synthesize verticalOverlayView=_verticalOverlayView;
