...
- (void).cxx_destruct;
- (void)getCityApiAllCityWithProvince:(id)arg1 withCountry:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4 cached:(CDUnknownBlockType)arg5;
- (void)switchToolCardPauseOrStarWithCardID:(id)arg1 switchStatus:(long long)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
- (void)getHomeToolCardPopSuccess:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
- (void)getHitoryToolCardPage:(long long)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)getUseToolCards:(long long)arg1 cardId:(id)arg2 cardNum:(long long)arg3 scid:(id)arg4 type:(long long)arg5 success:(CDUnknownBlockType)arg6 failure:(CDUnknownBlockType)arg7;
- (void)checkUserToolCard:(id)arg1 scid:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)getUserToolCardsInfo:(long long)arg1 scid:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)getLiveNobleDetailInfo:(id)arg1 level:(long long)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)getLiveNoblePopListSuccess:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
- (void)getUserAnchiveInfoWithId:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3 cached:(CDUnknownBlockType)arg4;
- (void)getLiveAppConfigSuccess:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
...
- (void)checkPKGiftsCollectBuffsWithScid:(id)arg1 andAnchorId:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
- (void)getPKResultAndScoreWithPKID:(long long)arg1 andAnchorID:(long long)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)keepPKAlive:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)requestPKSetting:(_Bool)arg1 allowRandomPk:(_Bool)arg2 allowStranger:(_Bool)arg3 scoreboard_mode:(_Bool)arg4 type:(long long)arg5 success:(CDUnknownBlockType)arg6 failure:(CDUnknownBlockType)arg7;
...
- (void)getPKRetryInfoWithScid:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)checkPKPermissionWithscid:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
...
- (void)sendPKInvitation:(id)arg1 scoreboard_mode:(int)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)matchPKWithMemberClick:(long long)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
...
- (void)requestInLiveRoomResourceByVersion:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (id)getPayParamsString:(id)arg1;
- (void)requestInnerAdWithParams:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3 cached:(CDUnknownBlockType)arg4;
...
- (void)roomProductClickReportWithScid:(id)arg1 anchorId:(id)arg2 memberId:(id)arg3 productId:(id)arg4 success:(CDUnknownBlockType)arg5 failure:(CDUnknownBlockType)arg6;
...
- (void)getMyRechargePopPercentageWithConfigKey:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)getProductsListSuccess:(id)arg1 productType:(long long)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)getReplayMySimpleWalletSuccess:(id)arg1 scid:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
- (void)getLoginUserWalletSuccess:(id)arg1 scid:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
- (void)getApplePaySuccess:(id)arg1 wbUID:(id)arg2 productId:(id)arg3 anchorId:(id)arg4 productType:(long long)arg5 scid:(id)arg6 isFrom:(id)arg7 from:(id)arg8 success:(CDUnknownBlockType)arg9 failure:(CDUnknownBlockType)arg10;
...
- (void)getNewGiftListCustomWithParams:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
...
- (void)getPrivateLiveInfoWithScid:(id)arg1 Success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)getWeiboOperateReport:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)getLiveSchemeWithOpenid:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)launchedWithType:(long long)arg1 andSource:(long long)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
- (void)getMemberInfo:(id)arg1 Success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)requestMicShareInfoWithLiveID:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
...
- (void)getSeatInfoWithLiveID:(id)arg1 andAnchorID:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
- (void)requestRedEnvelopInfoWithScid:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)getSignDays:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
- (void)getFreeBarrageNums:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
...
- (void)publishModelListSuccess:(CDUnknownBlockType)arg1 failure:(CDUnknownBlockType)arg2;
- (void)cancleAttentionWithId:(id)arg1 success:(CDUnknownBlockType)arg2 failure:(CDUnknownBlockType)arg3;
- (void)followUserWithId:(id)arg1 from:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
