...
@class NSString, UIView, UIViewController, WBFloatWindow;
...
- (void)animationWithFloatWindowDragView:(UIView *)arg1 superView:(UIView *)arg2;
- (_Bool)floatWindowCloseButtonHidden;
