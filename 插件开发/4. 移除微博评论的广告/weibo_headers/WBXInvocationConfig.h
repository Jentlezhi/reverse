...
@interface WBXInvocationConfig : NSObject
{
    NSString *_name;
    NSString *_clazz;
    NSMutableDictionary *_asyncMethods;
    NSMutableDictionary *_syncMethods;
    NSMutableDictionary *_caniuseMethods;
}

@property(retain, nonatomic) NSMutableDictionary *caniuseMethods; // @synthesize caniuseMethods=_caniuseMethods;
