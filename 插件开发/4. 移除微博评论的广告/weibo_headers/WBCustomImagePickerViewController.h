...
@interface WBCustomImagePickerViewController : WBViewController <AVCamCaptureManagerDelegate, UIGestureRecognizerDelegate, CAAnimationDelegate, CLLocationManagerDelegate>
{
    ...
    UIButton *_cameraDevice;
    UIButton *_flashBtn;
    UIButton *_albumButton;
    WBZoomButton *_zoomButton;
    VolumeListener *_volumeListener;
    long long _orientationLast;
    UIView *_headerBackgroundView;
    UIImageView *_shutterTopView;
    UIImageView *_shutterBottomView;
    ...
    UIImageView *_videoPreviewMaskView;
    WBVideoProgressView *_progressView;
}

@property(retain, nonatomic) WBVideoProgressView *progressView; // @synthesize progressView=_progressView;
@property(retain, nonatomic) UIImageView *videoPreviewMaskView; // @synthesize videoPreviewMaskView=_videoPreviewMaskView;
...
@property(retain, nonatomic) UIImageView *shutterBottomView; // @synthesize shutterBottomView=_shutterBottomView;
@property(retain, nonatomic) UIImageView *shutterTopView; // @synthesize shutterTopView=_shutterTopView;
@property(retain, nonatomic) UIView *headerBackgroundView; // @synthesize headerBackgroundView=_headerBackgroundView;
@property(nonatomic) long long orientationLast; // @synthesize orientationLast=_orientationLast;
@property(retain, nonatomic) VolumeListener *volumeListener; // @synthesize volumeListener=_volumeListener;
@property(retain, nonatomic) WBZoomButton *zoomButton; // @synthesize zoomButton=_zoomButton;
...
@property(retain, nonatomic) UIButton *cameraDevice; // @synthesize cameraDevice=_cameraDevice;
...
@property(nonatomic) _Bool isSiwtching; // @synthesize isSiwtching=_isSiwtching;
