...
@class NSMutableArray, NSString, SNHTTPRequestOperationWrapper, UIButton, UILabel, UIView, WBButton, WBPRLMTableViewWrapper, WBShopInfiniteScrollView, WBShopProduct, WBShopPublishButton, WBStatus, WBTableView, WBToolbar;

@interface WBShopProductInfoViewController : WBViewController <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, WBShopInfiniteScrollDelegate, PRLMTableViewWrapperDelegate>
{
    WBStatus *_status;
    _Bool isTaobao;
    _Bool isYouzan;
...
@property(nonatomic) _Bool isDeatilError; // @synthesize isDeatilError=_isDeatilError;
...
@property(retain, nonatomic) WBToolbar *topBar; // @synthesize topBar=_topBar;
