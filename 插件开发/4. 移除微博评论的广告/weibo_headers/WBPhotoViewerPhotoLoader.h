...
@class NSString, WBPhotoViewerPhoto, WBTDASIHTTPRequest;

@interface WBPhotoViewerPhotoLoader : NSObject <WBTDASIHTTPRequestDelegate>
{
...
- (void)actionTraceLogWithError:(id)arg1 imgUrl:(id)arg2 messageLog:(id)arg3;
- (void)fetchPaidInfoIfNeededThenLoadImageWithBlock:(CDUnknownBlockType)arg1;
- (id)reduceImageScale:(id)arg1;
- (void)startLoadStillImage:(id)arg1;
- (id)imageUrlWithAuth:(id)arg1;
- (void)startLoadPhotoNeedAuth:(id)arg1;
- (void)cancelLoad;
- (_Bool)needAuth;
- (void)startLoad;
