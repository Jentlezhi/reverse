...
@class NSString, TBLiveBrandADView, UIView, WXSDKInstance;

@interface TBLiveBrandADWeexComponent : WXComponent <WXModuleProtocol, TBLiveColleagueProtocol>
{
