...
@class NSString, UICollectionView, UILabel, XMCategoryRecModel, XMTableCellObject;
@protocol XMCategoryRecLiveCellDelegate;

@interface XMCategoryRecLiveCell : XMFindFlowWhiteBackTableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
    id <XMCategoryRecLiveCellDelegate> _delegate;
...
@property(nonatomic) __weak id <XMCategoryRecLiveCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
