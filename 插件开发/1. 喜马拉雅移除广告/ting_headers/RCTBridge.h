...
@class ALAssetsLibrary, KKGBundle, NSArray, NSDictionary, NSLock, NSString, NSURL, RCTAccessibilityManager, RCTDevMenu, RCTDevSettings, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTPerformanceLogger, RCTRedBox, RCTUIManager;
...
- (void)invalidate;
- (void)disableEnqueueAsyncMethodInvokes;
- (void)enableEnqueueAsyncMethodInvokes;
- (void)flushMethodInvokesInQueue;
- (_Bool)isBatchActive;
...
- (void)requestReload;
- (void)reload;
- (id)jsBoundExtraModuleForClass:(Class)arg1;
...
- (void)loadAdditionBundle:(id)arg1 dataFetchComplete:(CDUnknownBlockType)arg2 runComplete:(CDUnknownBlockType)arg3;
- (void)enqueueApplicationScript:(id)arg1 url:(id)arg2 onComplete:(CDUnknownBlockType)arg3;
@property(copy, nonatomic) KKGBundle *latestLoadBundle;
- (void)processStateWaitingHandlers:(long long)arg1;
- (void)recycle;
- (void)waitingForState:(long long)arg1 completed:(CDUnknownBlockType)arg2;
- (void)setWaitingStateHandlers:(id)arg1;
- (id)waitingStateHandlers;
@property(nonatomic) long long inPoolState;
