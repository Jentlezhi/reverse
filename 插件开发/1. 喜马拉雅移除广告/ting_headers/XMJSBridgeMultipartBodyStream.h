...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, XMJSBridgeHTTPBodyPart;
@protocol NSStreamDelegate;

@interface XMJSBridgeMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    XMJSBridgeHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) XMJSBridgeHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
