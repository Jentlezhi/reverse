...
@class NSString, XMVCStickerInfo;

@interface XMVCTransformElementView : UIView <XMVCTransformElement, XMVCStickerViewProtocol>
{
    XMVCStickerInfo *_stickerInfo;
    struct XMVCRotateRect _rotateRect;
}

@property(retain, nonatomic) XMVCStickerInfo *stickerInfo; // @synthesize stickerInfo=_stickerInfo;
