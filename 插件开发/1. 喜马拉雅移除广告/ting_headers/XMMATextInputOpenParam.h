...
@class NSString, XMMATextInputPlaceholderStyleParam, XMMATextInputStyleParam;

@interface XMMATextInputOpenParam : NSObject
{
    _Bool _password;
    _Bool _focus;
    _Bool _hide;
    ...
    NSString *_value;
    double _maxLength;
    XMMATextInputStyleParam *_style;
    double _cursorSpacing;
    long long _cursor;
    NSString *_placeholder;
    XMMATextInputPlaceholderStyleParam *_placeholderStyle;
...
@property(retain, nonatomic) XMMATextInputPlaceholderStyleParam *placeholderStyle; // @synthesize placeholderStyle=_placeholderStyle;
...
@property(retain, nonatomic) XMMATextInputStyleParam *style; // @synthesize style=_style;
