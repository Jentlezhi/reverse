...
#import "ABQAFMultipartFormData-Protocol.h"

@class ABQAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface ABQAFStreamingMultipartFormData : NSObject <ABQAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    ABQAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) ABQAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
