...
@interface XMAlbumRankListViewController : XMSubLevelViewController <UITableViewDelegate, UITableViewDataSource, XMTableViewDelegateProtocol, XMVXPageViewSubControllerProtocol>
{
    long long _pageId;
