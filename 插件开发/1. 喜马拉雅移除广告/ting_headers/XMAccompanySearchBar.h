...
@protocol XMAccompanySearchBarDelegate;

@interface XMAccompanySearchBar : UIView <UITextFieldDelegate>
{
    NSString *_text;
    _Bool _callBackUseMarkedText;
    _Bool _showMicroPhoneButton;
    _Bool _hiddenBottomLine;
    id <XMAccompanySearchBarDelegate> _delegate;
...
@property(nonatomic) __weak id <XMAccompanySearchBarDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
