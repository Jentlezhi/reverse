...
@class NSString, UICollectionView, UILabel, XMTableCellObject;

@interface XMPaidRecDiscountCell : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
    UILabel *_titleLabel;
