...
@protocol XMRecFlowNewUserVideoCellDelegate;

@interface XMRecFlowNewUserVideoCell : XMFindFlowWhiteBackTableViewCell <XMNewerUnlikeViewDelegate>
{
    id <XMRecFlowNewUserVideoCellDelegate> _delegate;
...
@property(nonatomic) __weak id <XMRecFlowNewUserVideoCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
