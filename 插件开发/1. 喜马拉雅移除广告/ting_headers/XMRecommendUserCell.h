...
@class UIButton, UIImageView, UILabel, XMPersonItem, XMTableCellObject, XMWebImageView;
@protocol XMRecommendUserCellDelegate;

@interface XMRecommendUserCell : XMTableViewCell
{
    ...
    id <XMRecommendUserCellDelegate> delegate;
    XMTableCellObject *_cellObj;
    UIImageView *_vLogoIcon;
}

+ (double)tableView:(id)arg1 heightForCellObject:(id)arg2;
+ (double)getCellHeightForPerson:(id)arg1 showVerifyTitle:(_Bool)arg2;
...
@property(nonatomic) __weak id <XMRecommendUserCellDelegate> delegate; // @synthesize delegate;
