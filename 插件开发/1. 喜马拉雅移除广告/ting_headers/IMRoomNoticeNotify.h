...
@interface IMRoomNoticeNotify : GPBMessage
{
}
...
@property(nonatomic) _Bool hasNoticeInfo; // @dynamic hasNoticeInfo;
...
@property(copy, nonatomic) NSString *noticeInfo; // @dynamic noticeInfo;
