...
@property(copy, nonatomic) NSArray *nameInRequest; // @synthesize nameInRequest=_nameInRequest;
@property(copy, nonatomic) NSArray *indexInPattern; // @synthesize indexInPattern=_indexInPattern;
