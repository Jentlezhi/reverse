...
@class CLGCDAsyncReadPacket, CLGCDAsyncSocketPreBuffer, CLGCDAsyncWritePacket, NSData, NSMutableArray, NSString;
@protocol OS_dispatch_queue, OS_dispatch_source;

@interface CLGCDAsyncSocket : NSObject
{
    unsigned int flags;
