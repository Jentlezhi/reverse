...
@class NSArray, NSString, UICollectionView, XMTableCellObject;

@interface XMPaidRecTagsCell : XMTableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
