...
@class CLAFNetworkReachabilityManager, CLAFSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol CLAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface CLAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <CLAFURLResponseSerialization> _responseSerializer;
...
@property(retain, nonatomic) id <CLAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
