...
@class CLCTCCGetMobileCodeModel, CLCTCCUIModel, UIActivityIndicatorView, UIButton, UIImageView, UILabel;
...
@property(retain, nonatomic) CLCTCCGetMobileCodeModel *ctccGetMobileCodeModel; // @synthesize ctccGetMobileCodeModel=_ctccGetMobileCodeModel;
- (void).cxx_destruct;
