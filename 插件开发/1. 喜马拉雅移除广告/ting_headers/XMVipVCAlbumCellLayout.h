...
@interface XMVipVCAlbumCellLayout : XMBaseLayout
{
    XMAlbumItem *_album;
    NSURL *_coverUrl;
    XMBaseLayout *_cover;
    ...
    XMYYLabelLayout *_albumInfo;
}

@property(retain, nonatomic) XMYYLabelLayout *albumInfo; // @synthesize albumInfo=_albumInfo;
