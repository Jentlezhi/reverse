...
@class LOTAnimationView, NSString, UIButton, UICollectionView, UILabel, XMFindRecFlowModel, XMTableCellObject;
@protocol XMRecFlowAlbumCardCellDelegate;

@interface XMRecFlowAlbumCardCell : UITableViewCell <UICollectionViewDelegate, UICollectionViewDataSource, XMRecFlowAlbumCardCellDelegate>
{
