...
@class NSData, NSMutableArray, NSString, NSURL, ZOAUReadPacket, ZOAUSocketPreBuffer, ZOAUWritePacket;
@protocol OS_dispatch_queue, OS_dispatch_source, ZOAUSocketDelegate;
...
@property _Bool useWifi; // @synthesize useWifi=_useWifi;
- (void).cxx_destruct;
- (struct SSLContext *)sslContext;
...
@property __weak id <ZOAUSocketDelegate> delegate;
