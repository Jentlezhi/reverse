...
@interface ABFaceLivenessView : UIView <ABViewDelegate>
{
    ...
    UIImageView *_circleInnerForeground;
    UIImageView *_circleOuterBackground;
    UIImageView *_circleOuterForeground;
    UIImageView *_resultIconBackground;
    UIImageView *_resultIconOk;
    UIImageView *_resultIconFail;
    UIImageView *_actionFinishPrompt;
    CMMotionManager *_motionManager;
    ABAudio *_audio;
    UIImageView *_waitingView;
    struct CGRect _circleOuterFrame;
...
@property(retain, nonatomic) UIImageView *resultIconFail; // @synthesize resultIconFail=_resultIconFail;
@property(retain, nonatomic) UIImageView *resultIconOk; // @synthesize resultIconOk=_resultIconOk;
...
@property(nonatomic) struct CGRect circleOuterFrame; // @synthesize circleOuterFrame=_circleOuterFrame;
@property(retain, nonatomic) UIImageView *circleOuterForeground; // @synthesize circleOuterForeground=_circleOuterForeground;
@property(retain, nonatomic) UIImageView *circleOuterBackground; // @synthesize circleOuterBackground=_circleOuterBackground;
@property(retain, nonatomic) UIImageView *circleInnerForeground; // @synthesize circleInnerForeground=_circleInnerForeground;
...
- (void)showErrorPrompt:(int)arg1 withTitle:(id)arg2 withMsg:(id)arg3 withPositiveText:(id)arg4 withPositiveDelegate:(id)arg5 withNegativeText:(id)arg6 withNegativeDelegate:(id)arg7 showIcon:(_Bool)arg8;
