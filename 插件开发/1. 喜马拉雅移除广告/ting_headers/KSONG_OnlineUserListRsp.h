...
@interface KSONG_OnlineUserListRsp : GPBMessage
{
}
...
@property(nonatomic) _Bool hasSingerId; // @dynamic hasSingerId;
...
@property(retain, nonatomic) NSMutableArray *onlineUserArray; // @dynamic onlineUserArray;
@property(readonly, nonatomic) unsigned long long onlineUserArray_Count; // @dynamic onlineUserArray_Count;
