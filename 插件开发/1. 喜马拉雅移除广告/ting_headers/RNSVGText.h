...
@class NSArray, NSString, RNSVGGlyphContext;
...
@property(retain, nonatomic) NSString *alignmentBaseline; // @synthesize alignmentBaseline=_alignmentBaseline;
@property(retain, nonatomic) NSString *lengthAdjust; // @synthesize lengthAdjust=_lengthAdjust;
@property(retain, nonatomic) NSString *baselineShift; // @synthesize baselineShift=_baselineShift;
@property(retain, nonatomic) NSString *textLength; // @synthesize textLength=_textLength;
- (void).cxx_destruct;
