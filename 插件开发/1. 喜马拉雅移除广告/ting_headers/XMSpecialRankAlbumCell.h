...
@class UIImageView, UILabel, UIView, XMAlbumCoverImageView, XMFeedsFlowInfoView, XMSpecialAlbumItem, YYLabel;

@interface XMSpecialRankAlbumCell : UITableViewCell
{
    ...
    XMSpecialAlbumItem *_model;
}

+ (double)tableView:(id)arg1 heightForCellObject:(id)arg2;
@property(retain, nonatomic) XMSpecialAlbumItem *model; // @synthesize model=_model;
