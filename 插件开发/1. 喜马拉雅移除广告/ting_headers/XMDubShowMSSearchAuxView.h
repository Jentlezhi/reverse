...
@interface XMDubShowMSSearchAuxView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, UITextFieldDelegate, UICollectionViewDelegateFlowLayout>
{
    CDUnknownBlockType _clickCancel;
    CDUnknownBlockType _clickPlayAction;
    CDUnknownBlockType _clickPlayMSLandAction;
...
@property(copy, nonatomic) CDUnknownBlockType clickPlayMSLandAction; // @synthesize clickPlayMSLandAction=_clickPlayMSLandAction;
