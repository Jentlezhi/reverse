...
@class ABQAFNetworkReachabilityManager, ABQAFSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol ABQAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface ABQAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <ABQAFURLResponseSerialization> _responseSerializer;
...
@property(retain, nonatomic) id <ABQAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
