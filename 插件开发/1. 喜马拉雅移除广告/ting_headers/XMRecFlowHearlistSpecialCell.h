...
@class UIImageView, UILabel, UIView, XMFeedsFlowInfoView, XMFindRecFlowModel, XMSpecialItem, XMTableCellObject, XMWebImageView;

@interface XMRecFlowHearlistSpecialCell : UITableViewCell
{
