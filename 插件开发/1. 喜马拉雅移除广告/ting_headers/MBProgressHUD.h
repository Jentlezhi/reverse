...
@class NSAttributedString, NSDate, NSString, NSTimer, UIColor, UIFont, UILabel;
...
@interface MBProgressHUD : UIView
{
    ...
    NSAttributedString *_attributeLabelText;
...
@property(nonatomic) _Bool isUserActive; // @synthesize isUserActive=_isUserActive;
...
@property float bottomMargin; // @synthesize bottomMargin=_bottomMargin;
@property float topMargin; // @synthesize topMargin=_topMargin;
@property(copy) NSAttributedString *attributeLabelText; // @synthesize attributeLabelText=_attributeLabelText;
...
- (void)layoutSubviews;
- (double)deltaY;
@property(readonly, nonatomic) double suggestedHideDelay;
- (struct CGSize)limitLabelWidth;
...
- (void)setUserActiveWhenLoading:(_Bool)arg1;
- (void)dealloc;
