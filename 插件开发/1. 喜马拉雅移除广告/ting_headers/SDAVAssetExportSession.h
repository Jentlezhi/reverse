...
@class AVAsset, AVAssetReader, AVAssetReaderAudioMixOutput, AVAssetReaderOutput, AVAssetReaderVideoCompositionOutput, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVAudioMix, AVVideoComposition, NSArray, NSDictionary, NSError, NSString, NSURL;
...
@property(retain, nonatomic) AVAssetReaderAudioMixOutput *audioMixOutput; // @synthesize audioMixOutput=_audioMixOutput;
...
- (_Bool)encodeReadySamplesFromMutipleOutputs:(id)arg1 toInput:(id)arg2;
- (_Bool)encodeReadySamplesFromOutput:(id)arg1 toInput:(id)arg2;
- (void)exportAsynchronouslyWithMutipleAudioTracksContactNoMixerCompletionHandler:(CDUnknownBlockType)arg1;
