...
#import "XMDynamicBlockCellDelegate-Protocol.h"

@class NSMutableArray, NSString, XMServerRequest;

@interface XMDynamicBlockListController : XMSubLevelViewController <XMDynamicBlockCellDelegate>
{
...
- (void).cxx_destruct;
- (void)clickAtDynamicBlockCell:(id)arg1;
