...
@interface XMFMPlaylistTableView : UITableView <UIGestureRecognizerDelegate>
{
    _Bool _ignoreCustomPan;
    UIPanGestureRecognizer *_pan;
    double _startY;
    struct CGPoint _startLocation;
}

@property(nonatomic) _Bool ignoreCustomPan; // @synthesize ignoreCustomPan=_ignoreCustomPan;
