...
@interface RNRecycleViewRefreshHeader : MJRefreshStateHeader
{
    UIImageView *_gifView;
    UIView *_customView;
    CDUnknownBlockType _onRefreshFinish;
    NSMutableDictionary *_stateImages;
    NSMutableDictionary *_stateDurations;
}

+ (id)headerWithRefreshingBlock:(CDUnknownBlockType)arg1 customView:(id)arg2;
...
@property(copy, nonatomic) CDUnknownBlockType onRefreshFinish; // @synthesize onRefreshFinish=_onRefreshFinish;
