...
#import "CLAFURLConnectionOperation.h"

@class CLAFHTTPResponseSerializer, NSError, NSHTTPURLResponse, NSRecursiveLock;
@protocol CLAFURLResponseSerialization;

@interface CLAFHTTPRequestOperation : CLAFURLConnectionOperation
{
