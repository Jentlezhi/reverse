...
@class CLAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;
@protocol NSStreamDelegate;

@interface CLAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    CLAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) CLAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
