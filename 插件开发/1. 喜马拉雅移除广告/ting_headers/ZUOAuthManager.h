...
- (void)closeCUOauthCachingStrategy:(_Bool)arg1;
- (void)oauth:(double)arg1 resultListener:(CDUnknownBlockType)arg2;
- (void)interruptTheCULoginFlow:(_Bool)arg1 ifDisapperTheShowingLoginPage:(_Bool)arg2 cancelTheNextAuthorizationPageToPullUp:(_Bool)arg3;
