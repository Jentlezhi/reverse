...
@class ABQAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface ABQAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    ABQAFURLSessionManager *_manager;
...
@property(nonatomic) __weak ABQAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
