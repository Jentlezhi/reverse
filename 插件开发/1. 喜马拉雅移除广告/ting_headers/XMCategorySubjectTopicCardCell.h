...
@class NSString, UIButton, UICollectionView, UILabel, XMCategoryRecModel, XMTableCellObject;
@protocol XMCategorySubjectTopicCardCellDelegate;

@interface XMCategorySubjectTopicCardCell : XMFindFlowWhiteBackTableViewCell <UICollectionViewDelegate, UICollectionViewDataSource>
{
    struct CGSize _itemSize;
    XMCategoryRecModel *_model;
    id <XMCategorySubjectTopicCardCellDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <XMCategorySubjectTopicCardCellDelegate> delegate; // @synthesize delegate=_delegate;
