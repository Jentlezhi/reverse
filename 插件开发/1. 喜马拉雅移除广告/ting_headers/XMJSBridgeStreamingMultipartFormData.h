...
#import "XMJSBridgeMultipartFormData-Protocol.h"

@class NSMutableURLRequest, NSString, XMJSBridgeMultipartBodyStream;

@interface XMJSBridgeStreamingMultipartFormData : NSObject <XMJSBridgeMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    XMJSBridgeMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) XMJSBridgeMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
