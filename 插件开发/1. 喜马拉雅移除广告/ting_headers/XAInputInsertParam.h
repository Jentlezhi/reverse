...
@interface XAInputInsertParam : NSObject <XMMANativeMethodParamProtocol>
{
    _Bool _password;
    _Bool _focus;
    _Bool _hide;
...
@property(nonatomic) _Bool isUpdateOperation; // @synthesize isUpdateOperation=_isUpdateOperation;
