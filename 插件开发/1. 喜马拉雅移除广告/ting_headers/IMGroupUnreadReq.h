...
@interface IMGroupUnreadReq : GPBMessage
{
}
...
@property(nonatomic) unsigned int filterSystemMsg; // @dynamic filterSystemMsg;
...
@property(nonatomic) _Bool hasFilterSystemMsg; // @dynamic hasFilterSystemMsg;
...
@property(nonatomic) _Bool hasMsgnum; // @dynamic hasMsgnum;
@property(nonatomic) _Bool hasReadId; // @dynamic hasReadId;
@property(nonatomic) _Bool hasReqType; // @dynamic hasReqType;
...
@property(nonatomic) unsigned int msgnum; // @dynamic msgnum;
