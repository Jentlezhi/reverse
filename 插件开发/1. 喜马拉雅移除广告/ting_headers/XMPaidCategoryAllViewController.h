...
@class MBProgressHUD, NSArray, NSMutableArray, NSString, UIButton, UIView, XMCategoryFilterTagView, XMCategorySortSelectView, XMServerRequest;

@interface XMPaidCategoryAllViewController : XMSubLevelViewController <XMAlbumCellDelegate, XMFilterTagViewDelegate>
{
    _Bool _isLoading;
...
- (void)startDataLoad;
- (void)viewDidLoad;
- (id)initWithPaidCategoryId:(long long)arg1;
- (void)dealloc;
- (void)safeClean;
