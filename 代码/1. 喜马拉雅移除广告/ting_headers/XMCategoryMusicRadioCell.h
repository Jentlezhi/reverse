...
@class UIImageView, UILabel, XMCategoryRecModel, XMTableCellObject, XMWebImageView;

@interface XMCategoryMusicRadioCell : UITableViewCell
{
    XMTableCellObject *_cellObject;
    XMWebImageView *_musicIcon;
    UILabel *_musicLabel;
    UILabel *_descLabel;
...
@property(retain, nonatomic) XMWebImageView *musicIcon; // @synthesize musicIcon=_musicIcon;
