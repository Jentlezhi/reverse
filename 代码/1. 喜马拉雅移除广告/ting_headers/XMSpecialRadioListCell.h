...
@protocol XMSpecialRadioListCellDelegate;

@interface XMSpecialRadioListCell : UITableViewCell
{
    id <XMSpecialRadioListCellDelegate> _delegate;
    UILabel *_titleLabel;
    UILabel *_countLabel;
...
@property(nonatomic) __weak id <XMSpecialRadioListCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
