...
@class ABQAFSecurityPolicy, NSData, NSDictionary, NSError, NSInputStream, NSObject, NSOutputStream, NSRecursiveLock, NSSet, NSString, NSURLConnection, NSURLCredential, NSURLRequest, NSURLResponse;
@protocol OS_dispatch_group, OS_dispatch_queue;

@interface ABQAFURLConnectionOperation : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSSecureCoding, NSCopying>
{
