...
@class CLAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface CLAFStreamingMultipartFormData : NSObject <AFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    CLAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) CLAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
