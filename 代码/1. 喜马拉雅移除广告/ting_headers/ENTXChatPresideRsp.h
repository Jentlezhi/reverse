...
@class NSString, RMBaseSdkInfo;

@interface ENTXChatPresideRsp : GPBMessage
{
}
...
@property(nonatomic) _Bool hasSdkInfo; // @dynamic hasSdkInfo;
...
@property(retain, nonatomic) RMBaseSdkInfo *sdkInfo; // @dynamic sdkInfo;
