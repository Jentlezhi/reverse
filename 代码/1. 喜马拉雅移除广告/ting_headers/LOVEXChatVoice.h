...
@interface LOVEXChatVoice : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *voicesArray; // @dynamic voicesArray;
@property(readonly, nonatomic) unsigned long long voicesArray_Count; // @dynamic voicesArray_Count;
