...
@interface IDA4AConnectionMonitor : NSObject
{
    ...
    double _startupCommunicationTimeout;
    NSConditionLock *_monitoringStateCondition;
    NSTimer *_communicationTimeoutTimer;
    NSTimer *_startupCommunicationTimeoutTimer;
...
@property(retain) NSTimer *startupCommunicationTimeoutTimer; // @synthesize startupCommunicationTimeoutTimer=_startupCommunicationTimeoutTimer;
...
@property(readonly) double startupCommunicationTimeout; // @synthesize startupCommunicationTimeout=_startupCommunicationTimeout;
...
- (void)handleStartupCommunicationTimeoutTimer:(id)arg1;
...
- (void)dealloc;
- (id)init;
- (id)initWithDelegate:(id)arg1 startupCommunicationTimeout:(double)arg2 communicationTimeout:(double)arg3;
