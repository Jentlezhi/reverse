...
- (void)hideAnimation;
- (void)showErrorPrompt:(int)arg1 withTitle:(NSString *)arg2 withMsg:(NSString *)arg3 withPositiveText:(NSString *)arg4 withPositiveDelegate:(id <ABFacePromptViewTouchDelegate>)arg5 withNegativeText:(NSString *)arg6 withNegativeDelegate:(id <ABFacePromptViewTouchDelegate>)arg7 showIcon:(_Bool)arg8;
