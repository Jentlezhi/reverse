...
@class CLAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface CLAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    CLAFURLSessionManager *_manager;
...
@property(nonatomic) __weak CLAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
