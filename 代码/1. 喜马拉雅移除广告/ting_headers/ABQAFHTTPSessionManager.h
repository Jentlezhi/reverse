...
#import "ABQAFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class ABQAFHTTPRequestSerializer, ABQAFHTTPResponseSerializer, NSURL;
@protocol ABQAFURLRequestSerialization, ABQAFURLResponseSerialization;

@interface ABQAFHTTPSessionManager : ABQAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) ABQAFHTTPResponseSerializer<ABQAFURLResponseSerialization> *responseSerializer;
