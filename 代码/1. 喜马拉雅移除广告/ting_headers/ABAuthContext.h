...
@class NSCondition, NSDate, NSString, UIViewController;
...
@property(retain) NSDate *lastLaunchDate; // @synthesize lastLaunchDate=_lastLaunchDate;
...
- (int)checkSGLicense:(id)arg1;
- (int)getSGLicenseResult;
- (id)signWithSG:(id)arg1 withAppkey:(id)arg2;
- (id)getAppKey;
- (id)invokeMethod:(Class)arg1 withName:(id)arg2 withParam:(id)arg3;
- (id)invokeMethod:(Class)arg1 withName:(id)arg2;
- (void)record:(id)arg1;
