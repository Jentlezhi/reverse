...
@interface MICXChatMICStartRsp : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *micUserListArray; // @dynamic micUserListArray;
@property(readonly, nonatomic) unsigned long long micUserListArray_Count; // @dynamic micUserListArray_Count;
