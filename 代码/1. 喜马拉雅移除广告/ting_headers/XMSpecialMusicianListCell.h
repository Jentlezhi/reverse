...
@protocol XMSpecialMusicianListCellDelegate;

@interface XMSpecialMusicianListCell : UITableViewCell
{
    id <XMSpecialMusicianListCellDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <XMSpecialMusicianListCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
