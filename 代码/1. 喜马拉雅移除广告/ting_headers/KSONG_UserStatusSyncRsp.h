...
@interface KSONG_UserStatusSyncRsp : GPBMessage
{
}
...
@property(nonatomic) _Bool hasPlayingSongId; // @dynamic hasPlayingSongId;
...
@property(nonatomic) unsigned long long playingSongId; // @dynamic playingSongId;
