...
@protocol XMSpecialEbookListCellDelegate;

@interface XMSpecialEbookListCell : UITableViewCell
{
    id <XMSpecialEbookListCellDelegate> _delegate;
    UILabel *_titleLabel;
...
@property(nonatomic) __weak id <XMSpecialEbookListCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
