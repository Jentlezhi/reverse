...
#import "CLAFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class CLAFHTTPRequestSerializer, CLAFHTTPResponseSerializer, NSURL;
@protocol CLAFURLRequestSerialization, CLAFURLResponseSerialization;

@interface CLAFHTTPSessionManager : CLAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) CLAFHTTPResponseSerializer<CLAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
