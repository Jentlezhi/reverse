...
@class NSMutableArray, NSMutableDictionary, NSString, NSURL, UIView, UIViewController, WVBridgeStorage, WXSDKInstance;
@protocol WVBridgeDelegate, WVWebViewBasicProtocol;
...
@interface WVBridge : NSObject <WVBridgeContext>
{
    ...
    NSString *_pageId;
    id <WVBridgeDelegate> _bridgeDelegate;
...
@property(retain, nonatomic) id <WVBridgeDelegate> bridgeDelegate; // @synthesize bridgeDelegate=_bridgeDelegate;
