...
@class CAKeyframeAnimation, NSString, UIButton, UIImageView, UILabel, UIView, XMComicAuthorCellModel, XMWebImageView;
@protocol XMComicAuthorCellDelegate;

@interface XMComicAuthorCell : XMTableViewCell
{
    XMComicAuthorCellModel *_model;
    id <XMComicAuthorCellDelegate> _delegate;
...
@property(nonatomic) __weak id <XMComicAuthorCellDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) XMComicAuthorCellModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
- (void)anchorGradeTap;
