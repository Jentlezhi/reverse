...
@class ABQAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface ABQAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    ABQAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) ABQAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
