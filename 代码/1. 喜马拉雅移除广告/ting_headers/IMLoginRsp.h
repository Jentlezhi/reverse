...
@class ArchInfo, NSMutableArray, NSString;

@interface IMLoginRsp : GPBMessage
{
}
...
@property(retain, nonatomic) NSMutableArray *loginCsinfoArray; // @dynamic loginCsinfoArray;
@property(readonly, nonatomic) unsigned long long loginCsinfoArray_Count; // @dynamic loginCsinfoArray_Count;
