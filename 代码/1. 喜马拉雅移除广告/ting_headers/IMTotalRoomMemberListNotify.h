...
@class ArchInfo, GPBUInt32Array;

@interface IMTotalRoomMemberListNotify : GPBMessage
{
}
...
@property(retain, nonatomic) GPBUInt32Array *roomMemberListArray; // @dynamic roomMemberListArray;
@property(readonly, nonatomic) unsigned long long roomMemberListArray_Count; // @dynamic roomMemberListArray_Count;
