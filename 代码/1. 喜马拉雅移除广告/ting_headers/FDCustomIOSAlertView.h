...
#import "ABCustomIOSAlertViewDelegate-Protocol.h"

@class NSArray;
@protocol ABCustomIOSAlertViewDelegate;

@interface FDCustomIOSAlertView : UIView <ABCustomIOSAlertViewDelegate>
{
    double buttonHeight;
    ...
    id <ABCustomIOSAlertViewDelegate> delegate;
...
@property(nonatomic) id <ABCustomIOSAlertViewDelegate> delegate; // @synthesize delegate;
