...
+ (id)resourcesWithVideoURL:(id)arg1 coverURL:(id)arg2;
+ (id)videoResourceWithVideoURL:(id)arg1;
+ (id)coverResourceWithImageURL:(id)arg1;
+ (id)imageResourceWithImageURL:(id)arg1;
...
@property(copy, nonatomic) NSString *hasWatermark; // @synthesize hasWatermark=_hasWatermark;
- (void).cxx_destruct;
- (id)preferredImageURL;
- (_Bool)hasCachedImage;
- (_Bool)hasCachedDecodeImage;
- (id)availableDownloadURL;
- (id)availableVideoURLItem;
