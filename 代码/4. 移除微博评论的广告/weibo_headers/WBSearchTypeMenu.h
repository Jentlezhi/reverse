...
@class NSArray, NSString, UIImageView, UITableView, WBSearchType, WBSearchTypeMenuDarkStyleEntity;
...
@interface WBSearchTypeMenu : UIView <UITableViewDelegate, UITableViewDataSource, WBSkinning>
{
    ...
    NSString *_backgroundImageNameForDirectionRight;
    NSString *_backgroundImageNameForDownRight;
...
@property(copy, nonatomic) NSString *backgroundImageNameForDownRight; // @synthesize backgroundImageNameForDownRight=_backgroundImageNameForDownRight;
@property(copy, nonatomic) NSString *backgroundImageNameForDirectionRight; // @synthesize backgroundImageNameForDirectionRight=_backgroundImageNameForDirectionRight;
