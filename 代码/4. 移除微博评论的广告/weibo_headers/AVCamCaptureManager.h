...
- (void)continuousFocusAndExposureAtPoint:(struct CGPoint)arg1;
...
- (void)captureImageWithScaleFactor:(double)arg1 andOrientation:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
