...
@protocol WBFreshNewsTableViewCellProtocol;

@interface WBFreshNewsTableViewCell : WBTableViewCell <WBMMAAutoMonitorDataProvider, WBPageCardViewProtocol>
{
    WBPageCardBubbleView *bubbleView;
    id <WBFreshNewsTableViewCellProtocol> delegate;
    UIImageView *separatorLineImageView;
    _Bool allowSeparatorLine;
    int _separatorLineStyle;
    float _willSetBubbleViewWidth;
    id <WBFreshNewsTableViewCellProtocol> _delegate;
}
...
@property(nonatomic) __weak id <WBFreshNewsTableViewCellProtocol> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
