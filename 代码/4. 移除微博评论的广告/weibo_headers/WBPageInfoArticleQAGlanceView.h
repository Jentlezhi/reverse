...
@class NSString, WBCommonButtonModel, WBCommonButtonStyleArticleQAGlaceView, WBContactAvatarView, WBContentImageView, WBInternalStyleButtonView, WBTimelineLargeCardTextView, WBTimelineScreenNameLabel, WBUser;

@interface WBPageInfoArticleQAGlanceView : WBPageInfoBaseCardView <WBCommonButtonViewDelegate, WBInternalStyleButtonViewDelegate>
{
    WBUser *user;
    ...
    WBInternalStyleButtonView *_answerButton;
}

+ (void)_linesArrayWithPageInfo:(id)arg1 callBack:(CDUnknownBlockType)arg2;
...
@property(retain, nonatomic) WBInternalStyleButtonView *answerButton; // @synthesize answerButton=_answerButton;
