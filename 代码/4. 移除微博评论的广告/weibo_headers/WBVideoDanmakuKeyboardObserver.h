...
@class UIView;
@protocol WBVideoDanmakuKeyboardObserverDelegate;

@interface WBVideoDanmakuKeyboardObserver : NSObject
{
    _Bool _keyboardVisible;
    _Bool _keyboardAnimating;
    _Bool _keyboardDisappearing;
    _Bool _keyboardAppearing;
    id <WBVideoDanmakuKeyboardObserverDelegate> _delegate;
    UIView *_owner;
}
...
@property(nonatomic) __weak id <WBVideoDanmakuKeyboardObserverDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
