...
@class NSString, SKStoreProductViewController, UIImageView, UIView, UIViewController, WBAdVideoNavigationBar, WBVideoItem, WBVideoPlaybackTransitionManager, WBVideoStorePlayerController, WBVideoStorePlayerView, WBVideoStoreView;
@protocol WBVideoPlayerSourceView;

@interface WBVideoStoreViewController : WBViewController <SKStoreProductViewControllerDelegate, WBVideoPlayerControllerDelegate, WBVideoStorePlayerControllerDelegate, WBVideoStorePlayerViewEventDelegate, WBVideoPlaybackTransitionManagerDelegate, WBAdVideoNavigationBarDelegate, UIViewControllerTransitioningDelegate>
{
    struct {
