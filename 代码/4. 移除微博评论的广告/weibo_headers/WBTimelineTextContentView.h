...
@class NSArray, NSMutableArray, NSMutableAttributedString, NSString, WBContentAuthView, WBTextRenderer, WBTimelineItemViewModel, WBTimelineLargeCardView, WBTimelineTableViewCellDrawingContext, WBTimelineTextRenderer;
...
@interface WBTimelineTextContentView : WBAsyncDrawingView <WBTimelineLargeCardViewDelegate, WBTextRendererDelegate, WBTextRendererEventDelegate>
{
    ...
    struct CGRect _handleEventFrame;
...
@property(nonatomic) struct CGRect handleEventFrame; // @synthesize handleEventFrame=_handleEventFrame;
...
@property(nonatomic) __weak WBTimelineItemViewModel *viewModel; // @synthesize viewModel=_viewModel;
...
- (_Bool)drawByViewModelInRect:(struct CGRect)arg1 withContext:(struct CGContext *)arg2 asynchronously:(_Bool)arg3 userInfo:(id)arg4;
...
- (void)byViewModelDrawMetaInfoWithTimelineItem:(id)arg1 InRect:(struct CGRect)arg2 withContext:(struct CGContext *)arg3 initialDrawingCount:(unsigned long long)arg4;
...
- (id)byViewModelAttributedStringIgnoreActiveRangeColorForAttributedString:(id)arg1;
