...
@interface WBVideoCachingCellContentImageView : WBContentImageView <WBVideoPlayerSourceView>
{
    id <WBVideoPlayerSourceView> _playerSourceViewDelegate;
}

@property(nonatomic) __weak id <WBVideoPlayerSourceView> playerSourceViewDelegate; // @synthesize playerSourceViewDelegate=_playerSourceViewDelegate;
- (void).cxx_destruct;
