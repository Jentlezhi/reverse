...
#import "WBNewControlsPluginDelegate-Protocol.h"
...
@class NSArray, NSDictionary, NSMutableArray, NSString, NSTimer, SNHTTPRequestOperationWrapper, UIButton, UIPanGestureRecognizer, UIView, WBContactEngine, WBMediaAutoPlayManager, WBStatus, WBTimeRecorder, WBVideoBlackRankShareInfo, WBVideoBlackRankTableViewCell, WBVideoPRLMTableViewWrapper, WBVideoPlaybackTransitionManager, WBVideoTimelineNewPlayerController, WBVideoTimelinePreviewContentView, WBVideoVoiceViewManager;
@protocol WBMediaPlaybackSourceView, WBVideoPlayerSourceView;

@interface WBVideoBlackRankViewController : WBVideoBlackBaseViewController <WBVideoTimelineTableViewCellDelegate, WBVideoUpNextPluginCountDownDelegate, UIViewControllerTransitioningDelegate, WBVideoTimelinePlayerControllerDelegate, UIGestureRecognizerDelegate, PRLMTableViewWrapperDelegate, WBVideoUpNextPluginViewVisibleDelegate, WBVideoTimelinePreviewContentViewDelegate, WBVideoPrefetchDataSource, WBTimeRecorderProtocol, WBVideoSegmentSwipeViewDelegate, WBNewControlsPluginDelegate, WBVideoPlaybackSchemeAutoTransitioning>
{
    ...
    WBVideoBlackRankTableViewCell *_bestCellForAutoPlay;
    NSString *_kid;
    NSString *_q;
    ...
    UIButton *_shareBtn;
    long long _cursor;
    WBVideoBlackRankShareInfo *_ranklistShareInfo;
...
@property(retain, nonatomic) WBVideoBlackRankShareInfo *ranklistShareInfo; // @synthesize ranklistShareInfo=_ranklistShareInfo;
...
@property(nonatomic) __weak WBVideoBlackRankTableViewCell *bestCellForAutoPlay; // @synthesize bestCellForAutoPlay=_bestCellForAutoPlay;
...
- (id)activeCell;
@property(readonly, nonatomic) WBVideoBlackRankTableViewCell *playingCell;
