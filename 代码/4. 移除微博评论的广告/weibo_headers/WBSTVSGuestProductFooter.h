...
@class NSString, UIButton, UIImageView, UIView, WBContentImageView, WBSTLikeAnimationView, WBStoryItemSegment;

@interface WBSTVSGuestProductFooter : WBSTVSBaseFooterView <WBStoryProductVCDelegate>
{
    UIView *_dotView;
