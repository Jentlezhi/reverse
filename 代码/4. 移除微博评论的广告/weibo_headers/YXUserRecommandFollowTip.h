...
@class NSString, NSTimer, UIButton, UIImageView, UILabel, YXButton, YXLiveBorderBGView, YXLiveUserView;

@interface YXUserRecommandFollowTip : UIView
{
    _Bool _isShowThreeSecondsFollow;
...
@property(retain, nonatomic) NSTimer *threeSecondsTimer; // @synthesize threeSecondsTimer=_threeSecondsTimer;
...
@property(nonatomic) _Bool isShowThreeSecondsFollow; // @synthesize isShowThreeSecondsFollow=_isShowThreeSecondsFollow;
...
- (void)automaticFollow:(id)arg1;
- (id)getThreeSecondsFollowStr:(long long)arg1;
- (void)showThreeSecondsFollow;
