...
@class NSMutableArray, NSMutableDictionary, UICollectionView, WXLength;
@protocol WXMultiColumnLayoutDelegate;
...
@interface WXMultiColumnLayout : UICollectionViewLayout
{
    ...
    UICollectionView *_weak_collectionView;
...
@property(nonatomic) __weak UICollectionView *weak_collectionView; // @synthesize weak_collectionView=_weak_collectionView;
...
@property(readonly, nonatomic) int computedColumnCount;
@property(readonly, nonatomic) double computedColumnWidth;
