...
@class AVAsset, AVAssetReader, AVAssetReaderAudioMixOutput, AVAssetReaderVideoCompositionOutput, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, AVAudioMix, AVVideoComposition, NSArray, NSDictionary, NSError, NSMutableDictionary, NSString, NSURL, WBAssetExportSessionTranscodeSettings;
...
@interface WBAssetExportSession : NSObject
{
    ...
    WBAssetExportSessionTranscodeSettings *_transcodeSettings;
    CDStruct_e83c9415 _timeRange;
}

+ (id)exportSessionWithAsset:(id)arg1;
@property(retain, nonatomic) WBAssetExportSessionTranscodeSettings *transcodeSettings; // @synthesize transcodeSettings=_transcodeSettings;
...
- (_Bool)hevcEnabled;
- (id)initWithAsset:(id)arg1 transcodeSettings:(id)arg2;
