...
@protocol YYLiveAnimatedImage, YYLiveAnimatedImageViewDelegate;

@interface YYLiveAnimatedImageView : UIImageView
{
    UIImage<YYLiveAnimatedImage> *_curAnimatedImage;
    ...
    id <YYLiveAnimatedImageViewDelegate> _delegate;
...
@property(nonatomic) __weak id <YYLiveAnimatedImageViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
