...
@interface WBMLClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
...
@property(readonly, nonatomic) WBMLClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;
