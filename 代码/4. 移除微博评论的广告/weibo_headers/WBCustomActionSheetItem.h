...
@interface WBCustomActionSheetItem : NSObject
{
    ...
    NSString *_itemHighlightedIconURL;
...
@property(retain, nonatomic) NSString *itemHighlightedIconURL; // @synthesize itemHighlightedIconURL=_itemHighlightedIconURL;
@property(retain, nonatomic) UIImage *itemHighlightedIcon; // @synthesize itemHighlightedIcon=_itemHighlightedIcon;
@property(retain, nonatomic) NSString *itemIconURL; // @synthesize itemIconURL=_itemIconURL;
...
- (id)initWithItemType:(long long)arg1 Title:(id)arg2 TitleColor:(id)arg3 Icon:(id)arg4 iconURL:(id)arg5 highlightedIcon:(id)arg6 highlightedIconURL:(id)arg7 andIconLevel:(unsigned long long)arg8 andCompletionBlock:(CDUnknownBlockType)arg9;
