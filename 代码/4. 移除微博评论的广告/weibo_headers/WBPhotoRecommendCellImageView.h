...
@class NSDictionary, NSString, NSValue, UIImage, WBPhotoRecommendPhotoItem, WBStatus, WBTimelinePageInfo;
@protocol WBMediaPlaybackItem;

@interface WBPhotoRecommendCellImageView : WBContentImageView <WBMediaPlaybackSourceView, WeiboCubePhotoViewerFromViewProtocol>
{
    WBPhotoRecommendPhotoItem *_photoItem;
    WBStatus *_status;
...
@property(retain, nonatomic) WBPhotoRecommendPhotoItem *photoItem; // @synthesize photoItem=_photoItem;
- (void).cxx_destruct;
