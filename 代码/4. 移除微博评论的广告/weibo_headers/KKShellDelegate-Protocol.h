...
@optional
- (_Bool)KKShell:(KKShell *)arg1 application:(KKApplication *)arg2 openViewController:(UIViewController *)arg3 action:(NSDictionary *)arg4;
...
- (void)KKShell:(KKShell *)arg1 loading:(NSURL *)arg2 path:(NSString *)arg3 appInfo:(id)arg4;
- (void)KKShell:(KKShell *)arg1 loading:(NSURL *)arg2 path:(NSString *)arg3 count:(long long)arg4 totalCount:(long long)arg5;
