...
@class NSDictionary, NSMutableArray, NSString, UIBarButtonItem, UIImageView, UIView, WBCardViewBubbleView, WBContactEngine, WBFeedGroup, WBGridView, WBIndicatorView, WBUGNewSearchBar;
...
@property(retain, nonatomic) WBUGNewSearchBar *searchBar; // @synthesize searchBar;
