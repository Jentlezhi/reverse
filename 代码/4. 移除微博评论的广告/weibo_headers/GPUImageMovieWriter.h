...
@interface GPUImageMovieWriter : NSObject <GPUImageInput>
{
    ...
    long long _appendedPixelBufferCount;
}

@property(readonly, nonatomic) long long appendedPixelBufferCount; // @synthesize appendedPixelBufferCount=_appendedPixelBufferCount;
