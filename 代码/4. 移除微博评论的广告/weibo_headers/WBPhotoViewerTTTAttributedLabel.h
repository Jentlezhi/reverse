...
#import "WBPhotoViewerTTTAttributedLabel-Protocol.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, UIColor, UILongPressGestureRecognizer, WBPhotoViewerTTTAttributedLabelLink;
@protocol WBPhotoViewerTTTAttributedLabelDelegate;

@interface WBPhotoViewerTTTAttributedLabel : UILabel <WBPhotoViewerTTTAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    id <WBPhotoViewerTTTAttributedLabelDelegate> _delegate;
    ...
    NSArray *_linkModels;
    WBPhotoViewerTTTAttributedLabelLink *_activeLink;
...
@property(retain, nonatomic) WBPhotoViewerTTTAttributedLabelLink *activeLink; // @synthesize activeLink=_activeLink;
...
@property(nonatomic) id <WBPhotoViewerTTTAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
