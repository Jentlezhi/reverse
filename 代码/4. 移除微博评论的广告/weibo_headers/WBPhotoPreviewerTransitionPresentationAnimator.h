...
@class NSString, WBPhotoPreviewerTransitionController;

@interface WBPhotoPreviewerTransitionPresentationAnimator : NSObject <UIViewControllerAnimatedTransitioning>
{
    double _duration;
