...
@interface YXGLView : UIView
{
    ...
    _Bool _isUseRenderGpuOpt;
    _Bool _isUseRenderProcessOpt;
    _Bool _isVideoCaptureStopOpt;
    _Bool _isUseIOSEncoderOpt;
    ...
    YXGLDownMem *_glDownMemForEncode;
    YXGLLogo *_glLogo;
...
@property(nonatomic) char *pNV12ImageOut; // @synthesize pNV12ImageOut=_pNV12ImageOut;
@property(nonatomic) _Bool isUseIOSEncoderOpt; // @synthesize isUseIOSEncoderOpt=_isUseIOSEncoderOpt;
@property(nonatomic) _Bool isVideoCaptureStopOpt; // @synthesize isVideoCaptureStopOpt=_isVideoCaptureStopOpt;
@property(nonatomic) _Bool isUseRenderProcessOpt; // @synthesize isUseRenderProcessOpt=_isUseRenderProcessOpt;
@property(nonatomic) _Bool isUseRenderGpuOpt; // @synthesize isUseRenderGpuOpt=_isUseRenderGpuOpt;
...
@property(retain, nonatomic) UIView *uPointView; // @synthesize uPointView=_uPointView;
...
@property(retain, nonatomic) YXGLDownMem *glDownMemForEncode; // @synthesize glDownMemForEncode=_glDownMemForEncode;
...
@property(retain, nonatomic) EAGLContext *glShareContext; // @synthesize glShareContext=_glShareContext;
...
- (struct __CVBuffer *)getDeepCopyPixelBuffer:(struct __CVBuffer *)arg1;
...
- (void)setUseIOSEncoderOpt:(_Bool)arg1;
- (void)setStopVideoCaptureOpt:(_Bool)arg1;
- (void)setRenderProcessOpt:(_Bool)arg1;
...
- (void)setPoint:(struct CGPoint)arg1 x:(double)arg2 y:(double)arg3 w:(double)arg4 h:(double)arg5;
