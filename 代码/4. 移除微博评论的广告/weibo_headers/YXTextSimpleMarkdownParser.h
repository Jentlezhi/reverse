...
#import "YXTextParser-Protocol.h"

@class NSMutableArray, NSRegularExpression, NSString, UIColor, UIFont, YXTextBorder;

@interface YXTextSimpleMarkdownParser : NSObject <YXTextParser>
{
    UIFont *_font;
