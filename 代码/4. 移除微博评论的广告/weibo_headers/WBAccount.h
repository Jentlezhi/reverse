...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, WBAccountCredential, WBAccountPushSettings, WBAccountUnreadCount, WBHCUserSettings, WBStorySettings, WBUser;
...
@property(retain, nonatomic) NSString *teenager_sign; // @synthesize teenager_sign=_teenager_sign;
...
@property(retain, nonatomic) NSDictionary *abtestData; // @synthesize abtestData=_abtestData;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool isYouth;
