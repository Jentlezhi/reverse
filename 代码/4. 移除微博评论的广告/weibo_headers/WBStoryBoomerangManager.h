...
@protocol OS_dispatch_queue, OS_dispatch_semaphore, WBLocking, WBStoryBoomerangManagerDelegate;
...
@property(retain, nonatomic) id <WBLocking> lock; // @synthesize lock=_lock;
