...
@class UIImageView, UILabel, UIView, WBNewStoryImageURLButton, WBStoryUserView, WBStoryViewer;

@interface WBNewStoryViewerTableViewCell : WBTableViewCell
{
    WBStoryViewer *_user;
    ...
    UILabel *_fromLabel;
    WBNewStoryImageURLButton *_fromButton;
}

@property(retain, nonatomic) WBNewStoryImageURLButton *fromButton; // @synthesize fromButton=_fromButton;
