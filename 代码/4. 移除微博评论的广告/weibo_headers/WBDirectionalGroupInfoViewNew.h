...
@protocol WBDirectionalGroupInfoViewDelegateNew;

@interface WBDirectionalGroupInfoViewNew : UIView
{
    ...
    id <WBDirectionalGroupInfoViewDelegateNew> _delegate;
...
@property(nonatomic) id <WBDirectionalGroupInfoViewDelegateNew> delegate; // @synthesize delegate=_delegate;
