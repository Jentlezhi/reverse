...
@class NSArray, NSString, WBArticlePragraphModel, WBPageCard, WBPageCardViewBase;
@protocol WBMediaAutoPlayProviderDataModel;

@interface ArticleCardCell : RecyclableScrollViewCell <WBPageCardViewProtocol, WBMediaAutoPlaySourceViewProvider>
{
