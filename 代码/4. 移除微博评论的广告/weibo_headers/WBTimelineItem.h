...
#import "WeiboCubeTimelineItemParameterProtocol-Protocol.h"

@class NSArray, NSAttributedString, NSDate, NSDictionary, NSMutableDictionary, NSString, WBLikeListTag, WBQueueJob, WBTimelineItemViewModel, WBTimelinePageInfo, WBTimelineTableViewCellDrawingContext, WBTimelineTimestampInfo, WBUser;
@protocol WBMediaAutoPlayProviderDataModel, WBTimeLineItemActionTypesDelegate;

@interface WBTimelineItem : WBModelObject <WBExtraTimeRecordProtocol, WBMediaAutoPlayProviderDataModel, WeiboCubeTimelineItemParameterProtocol, WBDatabaseModel>
{
    NSString *itemID;
    NSString *v4ItemID;
    NSDate *date;
...
@property(retain, nonatomic) NSString *statusScreenScale; // @synthesize statusScreenScale=_statusScreenScale;
...
@property(retain, nonatomic) WBTimelineItemViewModel *viewModel; // @dynamic viewModel;
