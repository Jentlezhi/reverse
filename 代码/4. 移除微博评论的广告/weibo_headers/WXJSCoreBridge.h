...
- (void)registerCallUpdateFinish:(CDUnknownBlockType)arg1;
- (void)registerCallRefreshFinish:(CDUnknownBlockType)arg1;
...
- (void)registerCallUpdateComponentData:(CDUnknownBlockType)arg1;
