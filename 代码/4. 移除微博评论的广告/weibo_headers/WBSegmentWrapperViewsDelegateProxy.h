...
#import "WBBaseSegmentScrollableControllerProxy.h"
...
@interface WBSegmentWrapperViewsDelegateProxy : WBBaseSegmentScrollableControllerProxy <SwipeViewDelegate, SwipeViewDataSource, WBSegmentChannelsBarViewDelegate>
{
}
