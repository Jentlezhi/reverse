...
+ (void)registerService:(id)arg1 withScriptUrl:(id)arg2 withOptions:(id)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)registerService:(id)arg1 withScriptUrl:(id)arg2 withOptions:(id)arg3;
+ (void)registerService:(id)arg1 withScript:(id)arg2 withOptions:(id)arg3 completion:(CDUnknownBlockType)arg4;
