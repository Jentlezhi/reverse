...
@class NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest, WBXSRIOConsumerPool;
@protocol OS_dispatch_queue, WBXSRWebSocketDelegate;

@interface WBXSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    WBXSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    WBXSRIOConsumerPool *_consumerPool;
    _Bool _allowsUntrustedSSLCertificates;
    id <WBXSRWebSocketDelegate> _delegate;
    NSURL *_url;
...
@property(nonatomic) __weak id <WBXSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
